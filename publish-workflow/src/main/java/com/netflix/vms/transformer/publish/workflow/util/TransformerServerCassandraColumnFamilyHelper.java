...
public class TransformerServerCassandraColumnFamilyHelper implements TransformerCassandraColumnFamilyHelper {

    private final Keyspace keyspace;
    private final ColumnFamily<String, String> columnFamily;

    public TransformerServerCassandraColumnFamilyHelper(NFAstyanaxManager astyanaxManager, String clusterName, String keyspaceName, String columnFamilyName) {
