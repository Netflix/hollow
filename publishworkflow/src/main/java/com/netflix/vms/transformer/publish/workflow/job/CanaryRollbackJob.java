...
public abstract class CanaryRollbackJob extends PublicationJob {
    ...
    public CanaryRollbackJob(String vip, long cycleVersion, long priorVersion, long rollbackVersion, CanaryValidationJob validationJob) {
        super("canary-rollback", cycleVersion);
