 ...
 */
public final class SunjeetsOnboardingRootCassandraDao implements SunjeetsOnboardingRootDao {
    private static final Logger logger = LoggerFactory.getLogger(SunjeetsOnboardingRootCassandraDao.class);

    private static final String FULL_TABLE_NAME = "sunjeetsonboardingroot.greetings";
    ...
    @Inject
    public SunjeetsOnboardingRootCassandraDao(@Named("greetings") Session session) {
