...
public class RolloutPhaseTrailerSupplementalInfoDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, RolloutPhaseTrailerSupplementalInfoDelegate {
   ...
   private RolloutPhaseTrailerSupplementalInfoTypeAPI typeAPI;

    public RolloutPhaseTrailerSupplementalInfoDelegateCachedImpl(RolloutPhaseTrailerSupplementalInfoTypeAPI typeAPI, int ordinal) {
    ...
    public RolloutPhaseTrailerSupplementalInfoTypeAPI getTypeAPI() {
        return typeAPI;
    }

    public void updateTypeAPI(HollowTypeAPI typeAPI) {
        this.typeAPI = (RolloutPhaseTrailerSupplementalInfoTypeAPI) typeAPI;
    }
