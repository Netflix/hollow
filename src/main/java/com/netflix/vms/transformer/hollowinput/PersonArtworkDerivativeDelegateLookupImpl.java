...
public class PersonArtworkDerivativeDelegateLookupImpl extends HollowObjectAbstractDelegate implements PersonArtworkDerivativeDelegate {

    private final PersonArtworkDerivativeTypeAPI typeAPI;

    public PersonArtworkDerivativeDelegateLookupImpl(PersonArtworkDerivativeTypeAPI typeAPI) {
