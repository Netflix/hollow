...
public class CharacterArtworkDerivativeDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, CharacterArtworkDerivativeDelegate {
   ...
   private CharacterArtworkDerivativeTypeAPI typeAPI;

    public CharacterArtworkDerivativeDelegateCachedImpl(CharacterArtworkDerivativeTypeAPI typeAPI, int ordinal) {
    ...
    public CharacterArtworkDerivativeTypeAPI getTypeAPI() {
        return typeAPI;
    }

    public void updateTypeAPI(HollowTypeAPI typeAPI) {
        this.typeAPI = (CharacterArtworkDerivativeTypeAPI) typeAPI;
    }
