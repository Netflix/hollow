...
public class PersonArtworkDerivativeDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, PersonArtworkDerivativeDelegate {
   ...
   private PersonArtworkDerivativeTypeAPI typeAPI;

    public PersonArtworkDerivativeDelegateCachedImpl(PersonArtworkDerivativeTypeAPI typeAPI, int ordinal) {
    ...
    public PersonArtworkDerivativeTypeAPI getTypeAPI() {
        return typeAPI;
    }

    public void updateTypeAPI(HollowTypeAPI typeAPI) {
        this.typeAPI = (PersonArtworkDerivativeTypeAPI) typeAPI;
    }
