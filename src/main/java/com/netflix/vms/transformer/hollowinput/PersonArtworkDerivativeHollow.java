...
public class PersonArtworkDerivativeHollow extends HollowObject {

    public PersonArtworkDerivativeHollow(PersonArtworkDerivativeDelegate delegate, int ordinal) {
    ...
    public PersonArtworkDerivativeTypeAPI typeApi() {
        return delegate().getTypeAPI();
    }

    protected PersonArtworkDerivativeDelegate delegate() {
        return (PersonArtworkDerivativeDelegate)delegate;
    }
