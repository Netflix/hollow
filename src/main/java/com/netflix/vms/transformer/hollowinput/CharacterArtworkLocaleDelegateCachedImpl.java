...
public class CharacterArtworkLocaleDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, CharacterArtworkLocaleDelegate {

    private final int territoryCodesOrdinal;
    private final int bcp47CodeOrdinal;
    private final int effectiveDateOrdinal;
   private CharacterArtworkLocaleTypeAPI typeAPI;

    public CharacterArtworkLocaleDelegateCachedImpl(CharacterArtworkLocaleTypeAPI typeAPI, int ordinal) {
    ...
    public void updateTypeAPI(HollowTypeAPI typeAPI) {
        this.typeAPI = (CharacterArtworkLocaleTypeAPI) typeAPI;
    }
