...
public class CharacterArtworkDerivativeHollow extends HollowObject {

    public CharacterArtworkDerivativeHollow(CharacterArtworkDerivativeDelegate delegate, int ordinal) {
    ...
    public CharacterArtworkDerivativeTypeAPI typeApi() {
        return delegate().getTypeAPI();
    }

    protected CharacterArtworkDerivativeDelegate delegate() {
        return (CharacterArtworkDerivativeDelegate)delegate;
    }
