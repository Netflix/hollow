...
public class CharacterArtworkDerivativeDelegateLookupImpl extends HollowObjectAbstractDelegate implements CharacterArtworkDerivativeDelegate {

    private final CharacterArtworkDerivativeTypeAPI typeAPI;

    public CharacterArtworkDerivativeDelegateLookupImpl(CharacterArtworkDerivativeTypeAPI typeAPI) {
