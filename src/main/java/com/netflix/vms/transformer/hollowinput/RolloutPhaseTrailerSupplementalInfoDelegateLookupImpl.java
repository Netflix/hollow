...
public class RolloutPhaseTrailerSupplementalInfoDelegateLookupImpl extends HollowObjectAbstractDelegate implements RolloutPhaseTrailerSupplementalInfoDelegate {

    private final RolloutPhaseTrailerSupplementalInfoTypeAPI typeAPI;

    public RolloutPhaseTrailerSupplementalInfoDelegateLookupImpl(RolloutPhaseTrailerSupplementalInfoTypeAPI typeAPI) {
