...
public class CertificationSystemArrayOfRatingTypeAPI extends HollowListTypeAPI {

    private final HollowListLookupDelegate delegateLookupImpl;

    CertificationSystemArrayOfRatingTypeAPI(VMSHollowVideoInputAPI api, HollowListTypeDataAccess dataAccess) {
