...
public class PersonArtworkDerivativesHollow extends HollowObject {

    public PersonArtworkDerivativesHollow(PersonArtworkDerivativesDelegate delegate, int ordinal) {
    ...
    public PersonArtworkDerivativesTypeAPI typeApi() {
        return delegate().getTypeAPI();
    }

    protected PersonArtworkDerivativesDelegate delegate() {
        return (PersonArtworkDerivativesDelegate)delegate;
    }
