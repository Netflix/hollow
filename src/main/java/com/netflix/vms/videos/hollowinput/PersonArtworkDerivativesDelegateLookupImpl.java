...
public class PersonArtworkDerivativesDelegateLookupImpl extends HollowObjectAbstractDelegate implements PersonArtworkDerivativesDelegate {

    private final PersonArtworkDerivativesTypeAPI typeAPI;

    public PersonArtworkDerivativesDelegateLookupImpl(PersonArtworkDerivativesTypeAPI typeAPI) {
