...
public class CharactersBMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    CharactersBMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public CharactersBTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getCharactersBTranslatedTextsTypeAPI();
    }
