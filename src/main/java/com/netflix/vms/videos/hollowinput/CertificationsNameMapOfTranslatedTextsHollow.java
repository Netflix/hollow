...
public class CertificationsNameMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, CertificationsNameTranslatedTextsHollow> {

    public CertificationsNameMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public CertificationsNameTranslatedTextsHollow instantiateValue(int ordinal) {
        return (CertificationsNameTranslatedTextsHollow) api().getCertificationsNameTranslatedTextsHollow(ordinal);
    }
    ...
    public CertificationsNameMapOfTranslatedTextsTypeAPI typeApi() {
        return (CertificationsNameMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
