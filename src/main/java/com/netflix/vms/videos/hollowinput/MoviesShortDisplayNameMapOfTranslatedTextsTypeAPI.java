...
public class MoviesShortDisplayNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    MoviesShortDisplayNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public MoviesShortDisplayNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getMoviesShortDisplayNameTranslatedTextsTypeAPI();
    }
