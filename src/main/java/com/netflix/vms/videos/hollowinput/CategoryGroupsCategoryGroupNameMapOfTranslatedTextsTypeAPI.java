...
public class CategoryGroupsCategoryGroupNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    CategoryGroupsCategoryGroupNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public CategoryGroupsCategoryGroupNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getCategoryGroupsCategoryGroupNameTranslatedTextsTypeAPI();
    }
