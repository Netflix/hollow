...
public class PersonArtworkTypeAPI extends HollowObjectTypeAPI {
    ...
    public PersonArtworkArrayOfDerivativesTypeAPI getDerivativesTypeAPI() {
        return getAPI().getPersonArtworkArrayOfDerivativesTypeAPI();
    }
    ...
    public PersonArtworkArrayOfLocalesTypeAPI getLocalesTypeAPI() {
        return getAPI().getPersonArtworkArrayOfLocalesTypeAPI();
    }
    ...
    public PersonArtworkAttributesTypeAPI getAttributesTypeAPI() {
        return getAPI().getPersonArtworkAttributesTypeAPI();
    }
