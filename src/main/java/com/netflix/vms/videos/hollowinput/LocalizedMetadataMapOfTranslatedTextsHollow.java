...
public class LocalizedMetadataMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, LocalizedMetadataTranslatedTextsHollow> {

    public LocalizedMetadataMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public LocalizedMetadataTranslatedTextsHollow instantiateValue(int ordinal) {
        return (LocalizedMetadataTranslatedTextsHollow) api().getLocalizedMetadataTranslatedTextsHollow(ordinal);
    }
    ...
    public LocalizedMetadataMapOfTranslatedTextsTypeAPI typeApi() {
        return (LocalizedMetadataMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
