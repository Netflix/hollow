...
public class ConsolidatedCertificationSystemsDescriptionMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    ConsolidatedCertificationSystemsDescriptionMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public ConsolidatedCertificationSystemsDescriptionTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getConsolidatedCertificationSystemsDescriptionTranslatedTextsTypeAPI();
    }
