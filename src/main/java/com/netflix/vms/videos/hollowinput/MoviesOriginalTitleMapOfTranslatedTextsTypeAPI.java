...
public class MoviesOriginalTitleMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    MoviesOriginalTitleMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public MoviesOriginalTitleTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getMoviesOriginalTitleTranslatedTextsTypeAPI();
    }
