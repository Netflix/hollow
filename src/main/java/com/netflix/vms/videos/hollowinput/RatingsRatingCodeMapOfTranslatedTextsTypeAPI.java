...
public class RatingsRatingCodeMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    RatingsRatingCodeMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public RatingsRatingCodeTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getRatingsRatingCodeTranslatedTextsTypeAPI();
    }
