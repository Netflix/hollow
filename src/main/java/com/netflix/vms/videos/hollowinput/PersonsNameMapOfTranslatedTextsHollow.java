...
public class PersonsNameMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, PersonsNameTranslatedTextsHollow> {

    public PersonsNameMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public PersonsNameTranslatedTextsHollow instantiateValue(int ordinal) {
        return (PersonsNameTranslatedTextsHollow) api().getPersonsNameTranslatedTextsHollow(ordinal);
    }
    ...
    public PersonsNameMapOfTranslatedTextsTypeAPI typeApi() {
        return (PersonsNameMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
