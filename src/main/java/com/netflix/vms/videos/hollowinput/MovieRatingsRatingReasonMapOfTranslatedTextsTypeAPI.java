...
public class MovieRatingsRatingReasonMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    MovieRatingsRatingReasonMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public MovieRatingsRatingReasonTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getMovieRatingsRatingReasonTranslatedTextsTypeAPI();
    }
