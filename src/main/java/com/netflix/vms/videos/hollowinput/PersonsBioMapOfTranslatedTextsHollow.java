...
public class PersonsBioMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, PersonsBioTranslatedTextsHollow> {

    public PersonsBioMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public PersonsBioTranslatedTextsHollow instantiateValue(int ordinal) {
        return (PersonsBioTranslatedTextsHollow) api().getPersonsBioTranslatedTextsHollow(ordinal);
    }
    ...
    public PersonsBioMapOfTranslatedTextsTypeAPI typeApi() {
        return (PersonsBioMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
