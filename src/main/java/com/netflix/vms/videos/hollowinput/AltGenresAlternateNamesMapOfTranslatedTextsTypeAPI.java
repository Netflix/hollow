...
public class AltGenresAlternateNamesMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    AltGenresAlternateNamesMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public AltGenresAlternateNamesTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getAltGenresAlternateNamesTranslatedTextsTypeAPI();
    }
