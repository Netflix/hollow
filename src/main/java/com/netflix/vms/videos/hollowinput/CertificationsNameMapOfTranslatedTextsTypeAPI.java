...
public class CertificationsNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    CertificationsNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public CertificationsNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getCertificationsNameTranslatedTextsTypeAPI();
    }
