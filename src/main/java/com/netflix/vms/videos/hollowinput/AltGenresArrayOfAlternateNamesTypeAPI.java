...
public class AltGenresArrayOfAlternateNamesTypeAPI extends HollowListTypeAPI {

    private final HollowListLookupDelegate delegateLookupImpl;

    AltGenresArrayOfAlternateNamesTypeAPI(VMSHollowVideoInputAPI api, HollowListTypeDataAccess dataAccess) {
