...
public class FestivalsShortNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    FestivalsShortNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public FestivalsShortNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getFestivalsShortNameTranslatedTextsTypeAPI();
    }
