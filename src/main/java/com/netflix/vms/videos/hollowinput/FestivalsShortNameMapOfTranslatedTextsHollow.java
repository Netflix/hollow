...
public class FestivalsShortNameMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, FestivalsShortNameTranslatedTextsHollow> {

    public FestivalsShortNameMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public FestivalsShortNameTranslatedTextsHollow instantiateValue(int ordinal) {
        return (FestivalsShortNameTranslatedTextsHollow) api().getFestivalsShortNameTranslatedTextsHollow(ordinal);
    }
    ...
    public FestivalsShortNameMapOfTranslatedTextsTypeAPI typeApi() {
        return (FestivalsShortNameMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
