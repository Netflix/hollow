...
public class RolloutPhasesElementsDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, RolloutPhasesElementsDelegate {
   ...
   private RolloutPhasesElementsTypeAPI typeAPI;

    public RolloutPhasesElementsDelegateCachedImpl(RolloutPhasesElementsTypeAPI typeAPI, int ordinal) {
    ...
    public void updateTypeAPI(HollowTypeAPI typeAPI) {
        this.typeAPI = (RolloutPhasesElementsTypeAPI) typeAPI;
    }
