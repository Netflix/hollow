...
public class RolloutPhasesDelegateLookupImpl extends HollowObjectAbstractDelegate implements RolloutPhasesDelegate {

    private final RolloutPhasesTypeAPI typeAPI;

    public RolloutPhasesDelegateLookupImpl(RolloutPhasesTypeAPI typeAPI) {
