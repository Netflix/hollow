...
public class FestivalsSingularNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    FestivalsSingularNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public FestivalsSingularNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getFestivalsSingularNameTranslatedTextsTypeAPI();
    }
