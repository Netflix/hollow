...
public class RatingsDescriptionMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    RatingsDescriptionMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public RatingsDescriptionTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getRatingsDescriptionTranslatedTextsTypeAPI();
    }
