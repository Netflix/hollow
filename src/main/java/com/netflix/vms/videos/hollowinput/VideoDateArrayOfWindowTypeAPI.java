...
public class VideoDateArrayOfWindowTypeAPI extends HollowListTypeAPI {

    private final HollowListLookupDelegate delegateLookupImpl;

    VideoDateArrayOfWindowTypeAPI(VMSHollowVideoInputAPI api, HollowListTypeDataAccess dataAccess) {
