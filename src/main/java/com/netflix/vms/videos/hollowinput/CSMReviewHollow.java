...
public class CSMReviewHollow extends HollowObject {
    ...
    public long _getPlasticReleaseDate() {
        return delegate().getPlasticReleaseDate(ordinal);
    }

    public Long _getPlasticReleaseDateBoxed() {
        return delegate().getPlasticReleaseDateBoxed(ordinal);
    }
    ...
    public long _getReleaseDate() {
        return delegate().getReleaseDate(ordinal);
    }

    public Long _getReleaseDateBoxed() {
        return delegate().getReleaseDateBoxed(ordinal);
    }
