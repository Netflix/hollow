...
public class VideoArtWorkSourceAttributesHollow extends HollowObject {
    ...
    public VideoArtWorkSourceAttributesArrayOfIDENTIFIERSHollow _getIDENTIFIERS() {
        int refOrdinal = delegate().getIDENTIFIERSOrdinal(ordinal);
        if(refOrdinal == -1)
            return null;
        return  api().getVideoArtWorkSourceAttributesArrayOfIDENTIFIERSHollow(refOrdinal);
    }
    ...
    public VideoArtWorkSourceAttributesArrayOfThemesHollow _getThemes() {
        int refOrdinal = delegate().getThemesOrdinal(ordinal);
        if(refOrdinal == -1)
            return null;
        return  api().getVideoArtWorkSourceAttributesArrayOfThemesHollow(refOrdinal);
    }

    public VideoArtWorkSourceAttributesArrayOfAWARD_CAMPAIGNSHollow _getAWARD_CAMPAIGNS() {
        int refOrdinal = delegate().getAWARD_CAMPAIGNSOrdinal(ordinal);
        if(refOrdinal == -1)
            return null;
        return  api().getVideoArtWorkSourceAttributesArrayOfAWARD_CAMPAIGNSHollow(refOrdinal);
    }
    ...
    public VideoArtWorkSourceAttributesArrayOfPERSON_IDSHollow _getPERSON_IDS() {
        int refOrdinal = delegate().getPERSON_IDSOrdinal(ordinal);
        if(refOrdinal == -1)
            return null;
        return  api().getVideoArtWorkSourceAttributesArrayOfPERSON_IDSHollow(refOrdinal);
    }
