...
public class ConsolidatedVideoRatingsTypeAPI extends HollowObjectTypeAPI {
    ...
    ConsolidatedVideoRatingsTypeAPI(VMSHollowVideoInputAPI api, HollowObjectTypeDataAccess typeDataAccess) {
    ...
    public ConsolidatedVideoRatingsArrayOfRatingsTypeAPI getRatingsTypeAPI() {
        return getAPI().getConsolidatedVideoRatingsArrayOfRatingsTypeAPI();
    }
