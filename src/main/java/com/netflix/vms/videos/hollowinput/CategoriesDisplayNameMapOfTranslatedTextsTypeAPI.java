...
public class CategoriesDisplayNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    CategoriesDisplayNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public CategoriesDisplayNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getCategoriesDisplayNameTranslatedTextsTypeAPI();
    }
