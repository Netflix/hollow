...
public class CertificationsDescriptionMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    CertificationsDescriptionMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public CertificationsDescriptionTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getCertificationsDescriptionTranslatedTextsTypeAPI();
    }
