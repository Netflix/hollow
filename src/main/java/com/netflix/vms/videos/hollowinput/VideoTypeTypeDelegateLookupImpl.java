...
public class VideoTypeTypeDelegateLookupImpl extends HollowObjectAbstractDelegate implements VideoTypeTypeDelegate {

    private final VideoTypeTypeTypeAPI typeAPI;

    public VideoTypeTypeDelegateLookupImpl(VideoTypeTypeTypeAPI typeAPI) {
