...
public class VideoGeneralTypeAPI extends HollowObjectTypeAPI {
    ...
    public VideoGeneralArrayOfAliasesTypeAPI getAliasesTypeAPI() {
        return getAPI().getVideoGeneralArrayOfAliasesTypeAPI();
    }
    ...
    public VideoGeneralArrayOfTitleTypesTypeAPI getTitleTypesTypeAPI() {
        return getAPI().getVideoGeneralArrayOfTitleTypesTypeAPI();
    }
    ...
    public VideoGeneralArrayOfEpisodeTypesTypeAPI getEpisodeTypesTypeAPI() {
        return getAPI().getVideoGeneralArrayOfEpisodeTypesTypeAPI();
    }
