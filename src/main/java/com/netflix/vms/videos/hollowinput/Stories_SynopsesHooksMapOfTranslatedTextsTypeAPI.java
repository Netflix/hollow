...
public class Stories_SynopsesHooksMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    Stories_SynopsesHooksMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public Stories_SynopsesHooksTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getStories_SynopsesHooksTranslatedTextsTypeAPI();
    }
