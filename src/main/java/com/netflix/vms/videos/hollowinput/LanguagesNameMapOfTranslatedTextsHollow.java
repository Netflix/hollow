...
public class LanguagesNameMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, LanguagesNameTranslatedTextsHollow> {

    public LanguagesNameMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public LanguagesNameTranslatedTextsHollow instantiateValue(int ordinal) {
        return (LanguagesNameTranslatedTextsHollow) api().getLanguagesNameTranslatedTextsHollow(ordinal);
    }
    ...
    public LanguagesNameMapOfTranslatedTextsTypeAPI typeApi() {
        return (LanguagesNameMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
