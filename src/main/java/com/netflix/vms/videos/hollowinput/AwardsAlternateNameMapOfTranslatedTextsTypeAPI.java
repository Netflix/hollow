...
public class AwardsAlternateNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    AwardsAlternateNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public AwardsAlternateNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getAwardsAlternateNameTranslatedTextsTypeAPI();
    }
