...
public class LocalizedCharacterMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, LocalizedCharacterTranslatedTextsHollow> {

    public LocalizedCharacterMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public LocalizedCharacterTranslatedTextsHollow instantiateValue(int ordinal) {
        return (LocalizedCharacterTranslatedTextsHollow) api().getLocalizedCharacterTranslatedTextsHollow(ordinal);
    }
    ...
    public LocalizedCharacterMapOfTranslatedTextsTypeAPI typeApi() {
        return (LocalizedCharacterMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
