...
public class CSMReviewDelegateLookupImpl extends HollowObjectAbstractDelegate implements CSMReviewDelegate {
    ...
    public long getPlasticReleaseDate(int ordinal) {
        return typeAPI.getPlasticReleaseDate(ordinal);
    }

    public Long getPlasticReleaseDateBoxed(int ordinal) {
        return typeAPI.getPlasticReleaseDateBoxed(ordinal);
    }
    ...
    public long getReleaseDate(int ordinal) {
        return typeAPI.getReleaseDate(ordinal);
    }

    public Long getReleaseDateBoxed(int ordinal) {
        return typeAPI.getReleaseDateBoxed(ordinal);
    }
