...
public class PersonArtworkDerivativesDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, PersonArtworkDerivativesDelegate {
   ...
   private PersonArtworkDerivativesTypeAPI typeAPI;

    public PersonArtworkDerivativesDelegateCachedImpl(PersonArtworkDerivativesTypeAPI typeAPI, int ordinal) {
    ...
    public PersonArtworkDerivativesTypeAPI getTypeAPI() {
        return typeAPI;
    }

    public void updateTypeAPI(HollowTypeAPI typeAPI) {
        this.typeAPI = (PersonArtworkDerivativesTypeAPI) typeAPI;
    }
