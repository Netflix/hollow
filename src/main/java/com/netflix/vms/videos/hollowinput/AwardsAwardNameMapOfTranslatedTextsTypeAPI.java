...
public class AwardsAwardNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    AwardsAwardNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public AwardsAwardNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getAwardsAwardNameTranslatedTextsTypeAPI();
    }
