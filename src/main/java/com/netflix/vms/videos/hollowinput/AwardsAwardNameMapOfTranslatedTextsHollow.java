...
public class AwardsAwardNameMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, AwardsAwardNameTranslatedTextsHollow> {

    public AwardsAwardNameMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public AwardsAwardNameTranslatedTextsHollow instantiateValue(int ordinal) {
        return (AwardsAwardNameTranslatedTextsHollow) api().getAwardsAwardNameTranslatedTextsHollow(ordinal);
    }
    ...
    public AwardsAwardNameMapOfTranslatedTextsTypeAPI typeApi() {
        return (AwardsAwardNameMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
