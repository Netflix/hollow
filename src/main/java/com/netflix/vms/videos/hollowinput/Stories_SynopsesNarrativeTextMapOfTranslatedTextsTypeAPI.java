...
public class Stories_SynopsesNarrativeTextMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    Stories_SynopsesNarrativeTextMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public Stories_SynopsesNarrativeTextTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getStories_SynopsesNarrativeTextTranslatedTextsTypeAPI();
    }
