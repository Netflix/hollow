...
public class FestivalsFestivalNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    FestivalsFestivalNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public FestivalsFestivalNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getFestivalsFestivalNameTranslatedTextsTypeAPI();
    }
