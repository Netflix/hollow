...
public class RolloutPhasesElementsTrailersSupplementalInfoHollow extends HollowObject {

    public RolloutPhasesElementsTrailersSupplementalInfoHollow(RolloutPhasesElementsTrailersSupplementalInfoDelegate delegate, int ordinal) {
    ...
    public RolloutPhasesElementsTrailersSupplementalInfoTypeAPI typeApi() {
        return delegate().getTypeAPI();
    }

    protected RolloutPhasesElementsTrailersSupplementalInfoDelegate delegate() {
        return (RolloutPhasesElementsTrailersSupplementalInfoDelegate)delegate;
    }
