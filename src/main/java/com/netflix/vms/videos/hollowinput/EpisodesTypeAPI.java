...
public class EpisodesTypeAPI extends HollowObjectTypeAPI {
    ...
    EpisodesTypeAPI(VMSHollowVideoInputAPI api, HollowObjectTypeDataAccess typeDataAccess) {
    ...
    public EpisodesEpisodeNameTypeAPI getEpisodeNameTypeAPI() {
        return getAPI().getEpisodesEpisodeNameTypeAPI();
    }
