...
public class VideoPersonArrayOfCastTypeAPI extends HollowListTypeAPI {

    private final HollowListLookupDelegate delegateLookupImpl;

    VideoPersonArrayOfCastTypeAPI(VMSHollowVideoInputAPI api, HollowListTypeDataAccess dataAccess) {
