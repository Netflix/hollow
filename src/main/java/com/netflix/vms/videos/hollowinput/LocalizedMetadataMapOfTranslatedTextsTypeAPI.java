...
public class LocalizedMetadataMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    LocalizedMetadataMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public LocalizedMetadataTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getLocalizedMetadataTranslatedTextsTypeAPI();
    }
