...
public class VideoRightsFlagsMapOfFirstDisplayDatesTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    VideoRightsFlagsMapOfFirstDisplayDatesTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public VideoRightsFlagsFirstDisplayDatesTypeAPI getValueAPI() {
        return getAPI().getVideoRightsFlagsFirstDisplayDatesTypeAPI();
    }
