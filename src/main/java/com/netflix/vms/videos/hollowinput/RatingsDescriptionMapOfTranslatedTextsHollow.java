...
public class RatingsDescriptionMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, RatingsDescriptionTranslatedTextsHollow> {

    public RatingsDescriptionMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public RatingsDescriptionTranslatedTextsHollow instantiateValue(int ordinal) {
        return (RatingsDescriptionTranslatedTextsHollow) api().getRatingsDescriptionTranslatedTextsHollow(ordinal);
    }
    ...
    public RatingsDescriptionMapOfTranslatedTextsTypeAPI typeApi() {
        return (RatingsDescriptionMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
