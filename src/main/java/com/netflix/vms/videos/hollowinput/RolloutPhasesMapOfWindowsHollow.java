...
public class RolloutPhasesMapOfWindowsHollow extends HollowMap<MapKeyHollow, RolloutPhasesWindowsHollow> {

    public RolloutPhasesMapOfWindowsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public RolloutPhasesWindowsHollow instantiateValue(int ordinal) {
        return (RolloutPhasesWindowsHollow) api().getRolloutPhasesWindowsHollow(ordinal);
    }
    ...
    public RolloutPhasesMapOfWindowsTypeAPI typeApi() {
        return (RolloutPhasesMapOfWindowsTypeAPI) delegate.getTypeAPI();
    }
