...
public class EpisodesEpisodeNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    EpisodesEpisodeNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public EpisodesEpisodeNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getEpisodesEpisodeNameTranslatedTextsTypeAPI();
    }
