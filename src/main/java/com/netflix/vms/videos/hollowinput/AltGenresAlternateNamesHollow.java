...
public class AltGenresAlternateNamesHollow extends HollowObject {
    ...
    public AltGenresAlternateNamesMapOfTranslatedTextsHollow _getTranslatedTexts() {
        int refOrdinal = delegate().getTranslatedTextsOrdinal(ordinal);
        if(refOrdinal == -1)
            return null;
        return  api().getAltGenresAlternateNamesMapOfTranslatedTextsHollow(refOrdinal);
    }
