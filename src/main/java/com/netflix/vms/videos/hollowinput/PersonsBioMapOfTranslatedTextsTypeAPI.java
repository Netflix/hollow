...
public class PersonsBioMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    PersonsBioMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public PersonsBioTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getPersonsBioTranslatedTextsTypeAPI();
    }
