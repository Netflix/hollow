...
public class RatingsRatingCodeMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, RatingsRatingCodeTranslatedTextsHollow> {

    public RatingsRatingCodeMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public RatingsRatingCodeTranslatedTextsHollow instantiateValue(int ordinal) {
        return (RatingsRatingCodeTranslatedTextsHollow) api().getRatingsRatingCodeTranslatedTextsHollow(ordinal);
    }
    ...
    public RatingsRatingCodeMapOfTranslatedTextsTypeAPI typeApi() {
        return (RatingsRatingCodeMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
