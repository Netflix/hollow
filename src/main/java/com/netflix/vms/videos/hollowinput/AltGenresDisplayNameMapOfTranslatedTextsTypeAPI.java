...
public class AltGenresDisplayNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    AltGenresDisplayNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public AltGenresDisplayNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getAltGenresDisplayNameTranslatedTextsTypeAPI();
    }
