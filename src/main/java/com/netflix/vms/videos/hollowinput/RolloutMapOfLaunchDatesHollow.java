...
public class RolloutMapOfLaunchDatesHollow extends HollowMap<MapKeyHollow, RolloutLaunchDatesHollow> {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public RolloutLaunchDatesHollow instantiateValue(int ordinal) {
        return (RolloutLaunchDatesHollow) api().getRolloutLaunchDatesHollow(ordinal);
    }
