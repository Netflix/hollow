...
public class MoviesDisplayNameMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, MoviesDisplayNameTranslatedTextsHollow> {

    public MoviesDisplayNameMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public MoviesDisplayNameTranslatedTextsHollow instantiateValue(int ordinal) {
        return (MoviesDisplayNameTranslatedTextsHollow) api().getMoviesDisplayNameTranslatedTextsHollow(ordinal);
    }
    ...
    public MoviesDisplayNameMapOfTranslatedTextsTypeAPI typeApi() {
        return (MoviesDisplayNameMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
