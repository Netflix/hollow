...
public class MoviesSiteSynopsisMapOfTranslatedTextsHollow extends HollowMap<MapKeyHollow, MoviesSiteSynopsisTranslatedTextsHollow> {

    public MoviesSiteSynopsisMapOfTranslatedTextsHollow(HollowMapDelegate delegate, int ordinal) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public MoviesSiteSynopsisTranslatedTextsHollow instantiateValue(int ordinal) {
        return (MoviesSiteSynopsisTranslatedTextsHollow) api().getMoviesSiteSynopsisTranslatedTextsHollow(ordinal);
    }
    ...
    public MoviesSiteSynopsisMapOfTranslatedTextsTypeAPI typeApi() {
        return (MoviesSiteSynopsisMapOfTranslatedTextsTypeAPI) delegate.getTypeAPI();
    }
