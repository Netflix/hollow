...
public class LanguagesNameMapOfTranslatedTextsTypeAPI extends HollowMapTypeAPI {

    private final HollowMapLookupDelegate delegateLookupImpl;

    LanguagesNameMapOfTranslatedTextsTypeAPI(VMSHollowVideoInputAPI api, HollowMapTypeDataAccess dataAccess) {
    ...
    public LanguagesNameTranslatedTextsTypeAPI getValueAPI() {
        return getAPI().getLanguagesNameTranslatedTextsTypeAPI();
    }
