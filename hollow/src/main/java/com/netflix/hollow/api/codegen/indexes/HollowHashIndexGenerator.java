...
public class HollowHashIndexGenerator extends HollowIndexGenerator {
    ...
    public String generate() {
        ...
        for(HollowSchema schema : schemaList) {
            ...
            builder.append("            public " + hollowImplClassname(schema.getName()) + " deserializeFrom(int ordinal) {\n");
            builder.append("                return api.deserializeFrom" + hollowImplClassname(schema.getName()) + "(ordinal);\n");
            builder.append("            }\n");
            builder.append("        };\n");
            builder.append("    }\n\n");
        }
