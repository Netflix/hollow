        ...
        try {
            ...
            if (readStates.hasCurrent()) {
                ...
                if (artifacts.hasDelta()) {
                    ...
                    System.out.println("// SNAP: TODO: Before applying delta, checksum of TestObject type is " + current.getTypeState("TestObject").getChecksum(current.getTypeState("TestObject").getSchema()));
                    ...
                    System.out.println("// SNAP: TODO: After applying delta, checksum of TestObject type is " + current.getTypeState("TestObject").getChecksum(current.getTypeState("TestObject").getSchema()));
