...
public interface HollowStateEngine extends HollowDataset {
    ...
    /**
     * A header tag indicating that num shards for a type has changed from that of the prior version and its value
     * lists the type(s) that were resharded along with the before and after num shards in the fwd delta direction.
