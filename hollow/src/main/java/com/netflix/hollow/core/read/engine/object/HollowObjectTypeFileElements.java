 ...
 */
public class HollowObjectTypeFileElements {
    ...
    public HollowObjectTypeFileElements(HollowObjectSchema schema, ArraySegmentRecycler memoryRecycler) {
    ...
    void applyDelta(HollowObjectTypeFileElements fromData, HollowObjectTypeFileElements deltaData) {
        throw new UnsupportedOperationException();
