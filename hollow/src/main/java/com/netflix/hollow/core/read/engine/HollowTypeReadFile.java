 ...
 */
public abstract class HollowTypeReadFile implements HollowTypeDataAccess {
    ...
    public HollowTypeReadFile(HollowReadStateEngine stateEngine, HollowSchema schema) {
    ...
    @Override
    public HollowTypeReadFile getTypeState() {
        return this;
    }
