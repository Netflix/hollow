...
public class HollowSetTypeWriteState extends HollowTypeWriteState {
    ...
    // invoked once per runCycle, will gather stats for all- snapshot, delta, reverse delta
    private void gatherStatistics(boolean numShardsChanged) {   // SNAP: TODO: now this can be removed?
