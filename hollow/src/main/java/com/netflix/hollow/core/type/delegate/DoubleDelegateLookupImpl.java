...
public class DoubleDelegateLookupImpl extends HollowObjectAbstractDelegate implements DoubleDelegate {

    private final DoubleTypeAPI typeAPI;

    public DoubleDelegateLookupImpl(DoubleTypeAPI typeAPI) {
