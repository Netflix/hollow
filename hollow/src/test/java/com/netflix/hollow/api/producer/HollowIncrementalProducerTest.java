...
public class HollowIncrementalProducerTest {
    ...
    public void publishAndLoadASnapshot() {
        ...
        long nextVersion = incrementalProducer.runCycle(new HollowIncrementalProducer.IncrementalPopulator() {
            @Override
            public void populate(HollowIncrementalProducer.IncrementalWriteState newState) throws Exception {
                newState.addOrModify(new TypeA(1, "one", 100));
                newState.addOrModify(new TypeA(2, "two", 2));
                newState.addOrModify(new TypeA(3, "three", 300));
                newState.addOrModify(new TypeA(3, "three", 3));
                newState.addOrModify(new TypeA(4, "five", 6));
                newState.delete(new TypeA(5, "five", 5));

                newState.delete(new TypeB(2, "3"));
                newState.addOrModify(new TypeB(5, "5"));
                newState.addOrModify(new TypeB(5, "6"));
                newState.deleteByPrimaryKey(new RecordPrimaryKey("TypeB", new Object[]{3}));
            }
        });


        /// another new state with a single change
        long finalVersion = incrementalProducer.runCycle(new HollowIncrementalProducer.IncrementalPopulator() {
            @Override
            public void populate(HollowIncrementalProducer.IncrementalWriteState newState) throws Exception {
                newState.addOrModify(new TypeA(1, "one", 1000));
            }
        });
    ...
    public void continuesARestoredState() {
        ...
        long version = incrementalProducer.runCycle(new HollowIncrementalProducer.IncrementalPopulator() {
            @Override
            public void populate(HollowIncrementalProducer.IncrementalWriteState newState) throws Exception {
                newState.addOrModify(new TypeA(1, "one", 2));
                newState.addOrModify(new TypeA(2, "two", 2));
                newState.addOrModify(new TypeB(3, "three"));
            }
        });
