...
public class HollowObjectMapperFlatRecordParserTest {
  ...
  public void testSimpleSchemaEvolution() {
    ...
    myMapper.writeFlat(actual, myFlatRecordWriter);
    FlatRecord fr = myFlatRecordWriter.generateFlatRecord();

    HollowObjectMapper myMapper2 = new HollowObjectMapper(new HollowWriteStateEngine());
    myMapper2.initializeTypeState(V1.Movie.class);

    V1.Movie expected = myMapper2.readFlat(fr);
