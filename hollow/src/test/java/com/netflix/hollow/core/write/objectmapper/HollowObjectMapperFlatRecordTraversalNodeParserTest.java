...
public class HollowObjectMapperFlatRecordTraversalNodeParserTest {
    ...
    public void testSpecialWrapperTypes() {
        ...
        SpecialWrapperTypesTest result = mapper.readFlat(new FlatRecordTraversalObjectNode(fr));
    ...
    public void testSimpleTypes() {
        ...
        TypeWithAllSimpleTypes result = mapper.readFlat(new FlatRecordTraversalObjectNode(fr));
    ...
    public void testCollections() {
        ...
        TypeWithCollections result = mapper.readFlat(new FlatRecordTraversalObjectNode(fr));
    ...
    public void testMapFromVersionedTypes() {
        ...
        VersionedType1 result = readerMapper.readFlat(new FlatRecordTraversalObjectNode(fr));
    ...
    public void shouldMapNonPrimitiveWrapperToPrimitiveWrapperIfCommonFieldIsTheSame() {
        ...
        TypeStateA2 result = readerMapper.readFlat(new FlatRecordTraversalObjectNode(fr));
    ...
    public void shouldMapPrimitiveWrapperToNonPrimitiveWrapperIfCommonFieldIsTheSame() {
        ...
        TypeStateA1 result = readerMapper.readFlat(new FlatRecordTraversalObjectNode(fr));
