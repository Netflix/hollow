...
public class HollowDiffNestedSchemasTest {
    
    @Test
    public void testNestedDiff() throws Exception {
    ...
    @Test
    public void testNestedDiffMissingField() throws Exception {
        HollowReadStateEngine from = createStateEngine(false,
                new TypeA(1, 1, 1),
                new TypeA(2, 2, 2),
                new TypeA(3, 3, 3),
    ...
    @Test
    public void testNestedDiffMissingHierarchicalField() throws Exception {
