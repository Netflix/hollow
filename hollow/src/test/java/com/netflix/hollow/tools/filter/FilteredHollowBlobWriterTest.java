...
public class FilteredHollowBlobWriterTest {
    ...
    public void filtersDataFromBlob() throws IOException {
        ...
        reader.readSnapshot(HollowBlobInput.dataInputStream(new ByteArrayInputStream(filteredBlobStream.toByteArray())));
        
        filteredBlobStream.reset();
        blobWriter.filterDelta(new ByteArrayInputStream(deltaData), filteredBlobStream);
        
        reader.applyDelta(HollowBlobInput.dataInputStream(new ByteArrayInputStream(filteredBlobStream.toByteArray())));
