...
public class IndividualSupplementalIdentifierSetTestData extends HollowTestRecord {

    private static final HollowSetSchema SCHEMA = new HollowSetSchema("IndividualSupplementalIdentifierSet", "String", "value");

    private static ToIntFunction<StringTestData> hashFunction = null;

    private final List<StringTestData> elements = new ArrayList<>();

    public IndividualSupplementalIdentifierSetTestData(StringTestData... elements) {
        this.elements.addAll(Arrays.asList(elements));
    }

    public static IndividualSupplementalIdentifierSetTestData IndividualSupplementalIdentifierSet(StringTestData... elements) {
        return new IndividualSupplementalIdentifierSetTestData(elements);
    }
