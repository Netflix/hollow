...
@HollowTypeName(name="PersonArtworkSource")
public class PersonArtworkSource implements Cloneable {
    ...
    public PersonArtworkSource setSourceFileId(String sourceFileId) {
        this.sourceFileId = sourceFileId;
        return this;
    }
    public PersonArtworkSource setPersonId(long personId) {
        this.personId = personId;
        return this;
    }
    public PersonArtworkSource setIsFallback(boolean isFallback) {
        this.isFallback = isFallback;
        return this;
    }
    public PersonArtworkSource setFallbackSourceFileId(String fallbackSourceFileId) {
        this.fallbackSourceFileId = fallbackSourceFileId;
        return this;
    }
    public PersonArtworkSource setSeqNum(int seqNum) {
        this.seqNum = seqNum;
        return this;
    }
    public PersonArtworkSource setOrdinalPriority(int ordinalPriority) {
        this.ordinalPriority = ordinalPriority;
        return this;
    }
    public PersonArtworkSource setFileImageType(String fileImageType) {
        this.fileImageType = fileImageType;
        return this;
    }
    public PersonArtworkSource setPhaseTags(List<PhaseTag> phaseTags) {
        this.phaseTags = phaseTags;
        return this;
    }
    public PersonArtworkSource setIsSmoky(boolean isSmoky) {
        this.isSmoky = isSmoky;
        return this;
    }
    public PersonArtworkSource setRolloutExclusive(boolean rolloutExclusive) {
        this.rolloutExclusive = rolloutExclusive;
        return this;
    }
    public PersonArtworkSource setAttributes(ArtworkAttributes attributes) {
        this.attributes = attributes;
        return this;
    }
    public PersonArtworkSource setLocales(List<ArtworkLocale> locales) {
        this.locales = locales;
        return this;
    }
    public PersonArtworkSource addToPhaseTags(PhaseTag phaseTag) {
    ...
    public PersonArtworkSource addToLocales(ArtworkLocale artworkLocale) {
    ...
    public boolean equals(Object other) {
        ...
        if(!(other instanceof PersonArtworkSource))
            return false;

        PersonArtworkSource o = (PersonArtworkSource) other;
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("PersonArtworkSource{");
    ...
    public PersonArtworkSource clone() {
        try {
            PersonArtworkSource clone = (PersonArtworkSource)super.clone();
            return clone;
