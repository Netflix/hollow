...
public class ConsolidatedVideoCountryRatingUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public ConsolidatedVideoCountryRatingUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
