...
public class TimecodedMomentAnnotationUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public TimecodedMomentAnnotationUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
