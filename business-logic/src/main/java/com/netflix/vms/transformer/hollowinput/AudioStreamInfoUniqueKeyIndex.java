...
public class AudioStreamInfoUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public AudioStreamInfoUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
