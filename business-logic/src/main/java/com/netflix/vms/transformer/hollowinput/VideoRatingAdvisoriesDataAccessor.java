...
public class VideoRatingAdvisoriesDataAccessor extends AbstractHollowDataAccessor<VideoRatingAdvisoriesHollow> {
    ...
    public VideoRatingAdvisoriesDataAccessor(HollowReadStateEngine rStateEngine, VMSHollowInputAPI api) {
        super(rStateEngine, TYPE);
        this.api = api;
    }

    public VideoRatingAdvisoriesDataAccessor(HollowReadStateEngine rStateEngine, VMSHollowInputAPI api, String ... fieldPaths) {
        super(rStateEngine, TYPE, fieldPaths);
        this.api = api;
    }

    public VideoRatingAdvisoriesDataAccessor(HollowReadStateEngine rStateEngine, VMSHollowInputAPI api, PrimaryKey primaryKey) {
