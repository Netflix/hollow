...
public class RightsAssetSetIdPrimaryKeyIndex implements HollowConsumer.RefreshListener {
    ...
    public RightsAssetSetIdPrimaryKeyIndex(HollowConsumer consumer, String... fieldPaths) {
        ...
        try {
            ...
            this.idx = new HollowPrimaryKeyIndex(consumer.getStateEngine(), "RightsAssetSetId", fieldPaths);
