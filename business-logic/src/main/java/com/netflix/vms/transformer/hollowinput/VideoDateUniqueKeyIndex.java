...
public class VideoDateUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public VideoDateUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
