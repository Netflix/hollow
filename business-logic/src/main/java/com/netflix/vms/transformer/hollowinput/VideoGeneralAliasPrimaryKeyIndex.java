...
public class VideoGeneralAliasPrimaryKeyIndex extends AbstractHollowUniqueKeyIndex<VMSHollowInputAPI, VideoGeneralAliasHollow> {
    ...
    public VideoGeneralAliasPrimaryKeyIndex(HollowConsumer consumer, boolean isListenToDataRefreah) {
        this(consumer, isListenToDataRefreah, ((HollowObjectSchema)consumer.getStateEngine().getSchema("VideoGeneralAlias")).getPrimaryKey().getFieldPaths());
    }
