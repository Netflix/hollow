...
public class VideoStreamCropParamsPrimaryKeyIndex extends AbstractHollowUniqueKeyIndex<VMSHollowInputAPI, VideoStreamCropParamsHollow> {
    ...
    public VideoStreamCropParamsPrimaryKeyIndex(HollowConsumer consumer, boolean isListenToDataRefreah) {
        this(consumer, isListenToDataRefreah, ((HollowObjectSchema)consumer.getStateEngine().getSchema("VideoStreamCropParams")).getPrimaryKey().getFieldPaths());
    }
