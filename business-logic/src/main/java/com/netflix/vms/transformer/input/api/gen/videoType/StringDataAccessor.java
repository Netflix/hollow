...
public class StringDataAccessor extends AbstractHollowDataAccessor<HString> {
    ...
    public StringDataAccessor(HollowReadStateEngine rStateEngine, VideoTypeAPI api) {
        super(rStateEngine, TYPE);
        this.api = api;
    }

    public StringDataAccessor(HollowReadStateEngine rStateEngine, VideoTypeAPI api, String ... fieldPaths) {
        super(rStateEngine, TYPE, fieldPaths);
        this.api = api;
    }

    public StringDataAccessor(HollowReadStateEngine rStateEngine, VideoTypeAPI api, PrimaryKey primaryKey) {
