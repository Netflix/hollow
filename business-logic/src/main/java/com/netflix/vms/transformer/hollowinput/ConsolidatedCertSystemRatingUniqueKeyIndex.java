...
public class ConsolidatedCertSystemRatingUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public ConsolidatedCertSystemRatingUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
