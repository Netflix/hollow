...
public class IPLArtworkDerivativeSetPrimaryKeyIndex implements HollowConsumer.RefreshListener {
    ...
    public IPLArtworkDerivativeSetPrimaryKeyIndex(HollowConsumer consumer, String... fieldPaths) {
        ...
        try {
            ...
            this.idx = new HollowPrimaryKeyIndex(consumer.getStateEngine(), "IPLArtworkDerivativeSet", fieldPaths);
