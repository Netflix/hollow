...
public class CertificationSystemUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public CertificationSystemUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
