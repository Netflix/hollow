...
public class LocalizedCharacterUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public LocalizedCharacterUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
