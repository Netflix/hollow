...
public class StreamDrmInfoUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public StreamDrmInfoUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
