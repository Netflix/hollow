...
public class DisallowedSubtitleLangCodePrimaryKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public DisallowedSubtitleLangCodePrimaryKeyIndex(HollowConsumer consumer) {
        this(consumer, ((HollowObjectSchema)consumer.getStateEngine().getSchema("DisallowedSubtitleLangCode")).getPrimaryKey().getFieldPaths());
    }
    ...
    public DisallowedSubtitleLangCodePrimaryKeyIndex(HollowConsumer consumer, String... fieldPaths) {
        ...
        try {
            ...
            this.idx = new HollowPrimaryKeyIndex(consumer.getStateEngine(), "DisallowedSubtitleLangCode", fieldPaths);
