...
public class PersonVideoRoleUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public PersonVideoRoleUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
