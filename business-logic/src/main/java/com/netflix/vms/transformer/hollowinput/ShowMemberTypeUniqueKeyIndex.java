...
public class ShowMemberTypeUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public ShowMemberTypeUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
