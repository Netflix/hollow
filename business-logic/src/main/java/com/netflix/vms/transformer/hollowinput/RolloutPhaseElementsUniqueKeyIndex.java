...
public class RolloutPhaseElementsUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public RolloutPhaseElementsUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
