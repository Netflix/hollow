...
public class VideoDateWindowUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public VideoDateWindowUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
