...
public class StreamAssetMetadataUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public StreamAssetMetadataUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
