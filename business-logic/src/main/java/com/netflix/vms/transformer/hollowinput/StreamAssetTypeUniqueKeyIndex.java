...
public class StreamAssetTypeUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public StreamAssetTypeUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
