...
public class CycleDataAggregatorHelper {
    ...
    public static final TaggingLogger.LogTag LANGUAGE_CATALOG_PRE_PROMOTION_EARLY_TAG = Language_catalog_diff_early_promotion;
    ...
    public static final TaggingLogger.LogTag LANGUAGE_CATALOG_PRE_PROMOTION_DIFF_TAG = Language_catalog_diff_prePromo;
    public static final String LANGUAGE_CATALOG_PRE_PROMOTION_DIFF_MESSAGE = "titles that will get pre-promoted correctly, previously dropping " + "contracts/windows";
    ...
    public static final TaggingLogger.LogTag LANGUAGE_CATALOG_MISSING_DUBS_TAG = Language_catalog_Missing_Dubs;
    ...
    public static final TaggingLogger.LogTag LANGUAGE_CATALOG_MISSING_SUBS_TAG = Language_catalog_Missing_Subs;
