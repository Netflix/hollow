...
public class StreamDeploymentUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public StreamDeploymentUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
