...
public class VideoArtworkSourceDelegateLookupImpl extends HollowObjectAbstractDelegate implements VideoArtworkSourceDelegate {

    private final VideoArtworkSourceTypeAPI typeAPI;

    public VideoArtworkSourceDelegateLookupImpl(VideoArtworkSourceTypeAPI typeAPI) {
