...
public class DateWindowAggregator {
    ...
    public void mergeDateWindows() {
        ...
        sortedWindows.sort(new Comparator<DateWindow>() {
            public int compare(DateWindow o1, DateWindow o2) {
                int cmp = Long.compare(o1.startDateTimestamp, o2.startDateTimestamp);
                if(cmp == 0)
                    cmp = Long.compare(o1.endDateTimestamp, o2.endDateTimestamp);
                return cmp;
            }
        });
