...
public class ProtectionTypesPrimaryKeyIndex extends AbstractHollowUniqueKeyIndex<VMSHollowInputAPI, ProtectionTypesHollow> {
    ...
    public ProtectionTypesPrimaryKeyIndex(HollowConsumer consumer, boolean isListenToDataRefreah) {
        this(consumer, isListenToDataRefreah, ((HollowObjectSchema)consumer.getStateEngine().getSchema("ProtectionTypes")).getPrimaryKey().getFieldPaths());
    }
