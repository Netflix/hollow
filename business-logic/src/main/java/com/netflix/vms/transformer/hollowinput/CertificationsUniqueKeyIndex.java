...
public class CertificationsUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public CertificationsUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
