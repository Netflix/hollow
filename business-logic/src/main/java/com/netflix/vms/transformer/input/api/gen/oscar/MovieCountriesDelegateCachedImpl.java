...
public class MovieCountriesDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, MovieCountriesDelegate {

    private final Long movieId;
    private final int movieIdOrdinal;
    private final int countriesOrdinal;
    private final int lastUpdatedCountriesOrdinal;
    ...
    private MovieCountriesTypeAPI typeAPI;

    public MovieCountriesDelegateCachedImpl(MovieCountriesTypeAPI typeAPI, int ordinal) {
        ...
        this.lastUpdatedCountriesOrdinal = typeAPI.getLastUpdatedCountriesOrdinal(ordinal);
    ...
    public int getLastUpdatedCountriesOrdinal(int ordinal) {
        return lastUpdatedCountriesOrdinal;
    }
    ...
    public void updateTypeAPI(HollowTypeAPI typeAPI) {
        this.typeAPI = (MovieCountriesTypeAPI) typeAPI;
    }
