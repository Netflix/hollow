...
public class RightsAssetsPrimaryKeyIndex implements HollowConsumer.RefreshListener {
    ...
    public RightsAssetsPrimaryKeyIndex(HollowConsumer consumer, String... fieldPaths) {
        ...
        try {
            ...
            this.idx = new HollowPrimaryKeyIndex(consumer.getStateEngine(), "RightsAssets", fieldPaths);
