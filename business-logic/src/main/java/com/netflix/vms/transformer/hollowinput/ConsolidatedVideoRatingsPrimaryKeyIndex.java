...
public class ConsolidatedVideoRatingsPrimaryKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public ConsolidatedVideoRatingsPrimaryKeyIndex(HollowConsumer consumer) {
        this(consumer, ((HollowObjectSchema)consumer.getStateEngine().getSchema("ConsolidatedVideoRatings")).getPrimaryKey().getFieldPaths());
    }
    ...
    public ConsolidatedVideoRatingsPrimaryKeyIndex(HollowConsumer consumer, String... fieldPaths) {
        ...
        try {
            ...
            this.idx = new HollowPrimaryKeyIndex(consumer.getStateEngine(), "ConsolidatedVideoRatings", fieldPaths);
