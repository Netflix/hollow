...
public class PersonVideoUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public PersonVideoUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
