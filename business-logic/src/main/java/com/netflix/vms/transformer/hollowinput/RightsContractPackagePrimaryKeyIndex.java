...
public class RightsContractPackagePrimaryKeyIndex extends AbstractHollowUniqueKeyIndex<VMSHollowInputAPI, RightsContractPackageHollow> {
    ...
    public RightsContractPackagePrimaryKeyIndex(HollowConsumer consumer, boolean isListenToDataRefreah) {
        this(consumer, isListenToDataRefreah, ((HollowObjectSchema)consumer.getStateEngine().getSchema("RightsContractPackage")).getPrimaryKey().getFieldPaths());
    }
