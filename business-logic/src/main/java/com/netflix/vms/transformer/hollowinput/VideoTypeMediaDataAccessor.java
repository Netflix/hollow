...
public class VideoTypeMediaDataAccessor extends AbstractHollowDataAccessor<VideoTypeMediaHollow> {
    ...
    public VideoTypeMediaDataAccessor(HollowReadStateEngine rStateEngine) {
        super(rStateEngine, TYPE);
    }

    public VideoTypeMediaDataAccessor(HollowReadStateEngine rStateEngine, String ... fieldPaths) {
        super(rStateEngine, TYPE, fieldPaths);
    }

    public VideoTypeMediaDataAccessor(HollowReadStateEngine rStateEngine, PrimaryKey primaryKey) {
