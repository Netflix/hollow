...
public class PackageMomentUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public PackageMomentUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
