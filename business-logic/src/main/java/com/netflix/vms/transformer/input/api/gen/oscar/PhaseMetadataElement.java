...
public class PhaseMetadataElement extends HollowObject {

    public PhaseMetadataElement(PhaseMetadataElementDelegate delegate, int ordinal) {
        super(delegate, ordinal);
    }

    public long getAttributeId() {
        return delegate().getAttributeId(ordinal);
    }

    public Long getAttributeIdBoxed() {
        return delegate().getAttributeIdBoxed(ordinal);
    }
    ...
    public PhaseMetadataElementTypeAPI typeApi() {
        return delegate().getTypeAPI();
    }

    protected PhaseMetadataElementDelegate delegate() {
        return (PhaseMetadataElementDelegate)delegate;
    }
