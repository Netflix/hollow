...
public class RightsWindowTypeAPI extends HollowObjectTypeAPI {
    ...
    public RightsWindowTypeAPI(VMSHollowInputAPI api, HollowObjectTypeDataAccess typeDataAccess) {
    ...
    public boolean getOnHold(int ordinal) {
        if(fieldIndex[2] == -1)
            return missingDataHandler().handleBoolean("RightsWindow", ordinal, "onHold") == Boolean.TRUE;
