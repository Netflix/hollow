...
public class IndividualSupplementalThemeSetTypeAPI extends HollowSetTypeAPI {

    private final HollowSetLookupDelegate delegateLookupImpl;

    public IndividualSupplementalThemeSetTypeAPI(SupplementalAPI api, HollowSetTypeDataAccess dataAccess) {
