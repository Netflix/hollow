...
public class RightsWindowUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public RightsWindowUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
