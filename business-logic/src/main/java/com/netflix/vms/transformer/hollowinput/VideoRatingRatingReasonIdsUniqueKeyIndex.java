...
public class VideoRatingRatingReasonIdsUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public VideoRatingRatingReasonIdsUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
