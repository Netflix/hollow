...
public class StreamBoxInfoUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public StreamBoxInfoUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
