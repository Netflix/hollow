            ...
            for (RolloutHollow rollout : rolloutList) {
                ...
                if (phaseListHollow != null) {
                    for (RolloutPhaseHollow phaseHollow : phaseListHollow) {
                        ...
                        if (localized._getPOSTPLAY_COMPLETION() != null)
                            phase.rawL10nAttribs.put(new Strings("POSTPLAY_COMPLETION"), new Strings(localized._getPOSTPLAY_COMPLETION()._getValue()));
