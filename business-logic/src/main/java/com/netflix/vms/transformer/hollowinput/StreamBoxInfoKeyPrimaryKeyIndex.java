...
public class StreamBoxInfoKeyPrimaryKeyIndex extends AbstractHollowUniqueKeyIndex<VMSHollowInputAPI, StreamBoxInfoKeyHollow> {
    ...
    public StreamBoxInfoKeyPrimaryKeyIndex(HollowConsumer consumer, boolean isListenToDataRefreah, String... fieldPaths) {
        super(consumer, "StreamBoxInfoKey", isListenToDataRefreah, fieldPaths);
    }
