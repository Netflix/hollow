...
public class CdnDeploymentUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public CdnDeploymentUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
