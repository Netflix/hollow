...
public class VMSHollowInputAPI extends HollowAPI  {
    ...
    private final StreamBoxInfoKeyTypeAPI streamBoxInfoKeyTypeAPI;
    private final StreamBoxInfoTypeAPI streamBoxInfoTypeAPI;
    private final SetOfStreamBoxInfoTypeAPI setOfStreamBoxInfoTypeAPI;
    private final DashStreamHeaderDataTypeAPI dashStreamHeaderDataTypeAPI;
    ...
    private final TimecodedMomentAnnotationTypeAPI timecodedMomentAnnotationTypeAPI;
    private final TimecodeAnnotationsListTypeAPI timecodeAnnotationsListTypeAPI;
    private final TimecodeAnnotationTypeAPI timecodeAnnotationTypeAPI;
    ...
    private final HollowObjectProvider streamBoxInfoKeyProvider;
    private final HollowObjectProvider streamBoxInfoProvider;
    private final HollowObjectProvider setOfStreamBoxInfoProvider;
    private final HollowObjectProvider dashStreamHeaderDataProvider;
    ...
    private final HollowObjectProvider timecodedMomentAnnotationProvider;
    private final HollowObjectProvider timecodeAnnotationsListProvider;
    private final HollowObjectProvider timecodeAnnotationProvider;
    ...
    public VMSHollowInputAPI(HollowDataAccess dataAccess, Set<String> cachedTypes, Map<String, HollowFactory<?>> factoryOverrides, VMSHollowInputAPI previousCycleAPI) {
        ...
        objectCreationSampler = new HollowObjectCreationSampler("CharacterQuote","CharacterQuoteList","ChunkDurationsString","CodecPrivateDataString","Date","DerivativeTag","DownloadableId","DownloadableIdList","DrmInfoString","Episode","EpisodeList","ExplicitDate","ISOCountry","ISOCountryList","ISOCountrySet","ListOfDerivativeTag","Long","MapKey","MapOfFlagsFirstDisplayDates","PersonCharacter","CharacterList","MovieCharacterPerson","PersonVideoAliasId","PersonVideoAliasIdsList","PersonVideoRole","PersonVideoRolesList","PersonVideo","RightsContractPackage","ListOfRightsContractPackage","RolloutPhaseWindow","RolloutPhaseWindowMap","ShowMemberType","ShowMemberTypeList","ShowCountryLabel","StreamAssetMetadata","StreamBoxInfoKey","StreamBoxInfo","SetOfStreamBoxInfo","DashStreamHeaderData","StreamDimensions","StreamFileIdentification","StreamProfileId","StreamProfileIdList","String","AbsoluteSchedule","ArtWorkImageType","ArtworkRecipe","AudioStreamInfo","CSMReview","CacheDeploymentIntent","Cdn","CdnDeployment","CdnDeploymentSet","CertificationSystemRating","CertificationSystemRatingList","CertificationSystem","CharacterElements","Character","CinderCupTokenRecord","DamMerchStillsMoment","DamMerchStills","DisallowedSubtitleLangCode","DisallowedSubtitleLangCodesList","DisallowedAssetBundle","DisallowedAssetBundlesList","Contract","DrmHeaderInfo","DrmHeaderInfoList","DrmSystemIdentifiers","IPLArtworkDerivative","IPLDerivativeSet","IPLDerivativeGroup","IPLDerivativeGroupSet","IPLArtworkDerivativeSet","ImageStreamInfo","ListOfContract","Contracts","ListOfPackageTags","DeployablePackages","ListOfString","LocaleTerritoryCode","LocaleTerritoryCodeList","MapOfStringToLong","FeedMovieCountryLanguages","MasterSchedule","MultiValuePassthroughMap","OriginServer","OverrideSchedule","PackageDrmInfo","PackageDrmInfoList","PackageMoment","PackageMomentList","PhaseTag","PhaseTagList","ProtectionTypes","ReleaseDate","ListOfReleaseDates","RightsContractAsset","ListOfRightsContractAsset","RightsWindowContract","ListOfRightsWindowContract","RightsWindow","ListOfRightsWindow","Rights","RolloutPhaseArtworkSourceFileId","RolloutPhaseArtworkSourceFileIdList","RolloutPhaseArtwork","RolloutPhaseLocalizedMetadata","RolloutPhaseElements","RolloutPhase","RolloutPhaseList","Rollout","Season","SeasonList","SetOfString","Flags","ShowSeasonEpisode","SingleValuePassthroughMap","PassthroughData","ArtworkAttributes","ArtworkLocale","ArtworkLocaleList","CharacterArtworkSource","IndividualSupplemental","PersonArtworkSource","Status","StorageGroups","StreamAssetType","StreamDeploymentInfo","StreamDeploymentLabel","StreamDeploymentLabelSet","StreamDeployment","StreamDrmInfo","StreamProfileGroups","StreamProfiles","SupplementalsList","Supplementals","TerritoryCountries","TextStreamInfo","TimecodedMomentAnnotation","TimecodeAnnotationsList","TimecodeAnnotation","TopNAttribute","TopNAttributesSet","TopN","TranslatedTextValue","MapOfTranslatedText","AltGenresAlternateNames","AltGenresAlternateNamesList","LocalizedCharacter","LocalizedMetadata","StoriesSynopsesHook","StoriesSynopsesHookList","TranslatedText","AltGenres","AssetMetaDatas","Awards","Categories","CategoryGroups","Certifications","Characters","ConsolidatedCertSystemRating","ConsolidatedCertSystemRatingList","ConsolidatedCertificationSystems","Episodes","Festivals","Languages","MovieRatings","Movies","PersonAliases","PersonCharacterResource","Persons","Ratings","ShowMemberTypes","StoriesSynopses","TurboCollections","VMSAward","VideoArtworkSource","VideoAwardMapping","VideoAwardList","VideoAward","VideoDateWindow","VideoDateWindowList","VideoDate","VideoGeneralAlias","VideoGeneralAliasList","VideoGeneralEpisodeType","VideoGeneralEpisodeTypeList","VideoGeneralTitleType","VideoGeneralTitleTypeList","VideoGeneral","VideoId","ListOfVideoIds","PersonBio","VideoRatingAdvisoryId","VideoRatingAdvisoryIdList","VideoRatingAdvisories","ConsolidatedVideoCountryRating","ConsolidatedVideoCountryRatingList","ConsolidatedVideoRating","ConsolidatedVideoRatingList","ConsolidatedVideoRatings","VideoRatingRatingReasonIds","VideoRatingRatingReasonArrayOfIds","VideoRatingRatingReason","VideoRatingRating","VideoRatingArrayOfRating","VideoRating","VideoStreamCropParams","VideoStreamInfo","StreamNonImageInfo","PackageStream","PackageStreamSet","Package","VideoTypeMedia","VideoTypeMediaList","VideoTypeDescriptor","VideoTypeDescriptorSet","VideoType");
        ...
        typeDataAccess = dataAccess.getTypeDataAccess("StreamBoxInfoKey");
        if(typeDataAccess != null) {
            streamBoxInfoKeyTypeAPI = new StreamBoxInfoKeyTypeAPI(this, (HollowObjectTypeDataAccess)typeDataAccess);
        } else {
            streamBoxInfoKeyTypeAPI = new StreamBoxInfoKeyTypeAPI(this, new HollowObjectMissingDataAccess(dataAccess, "StreamBoxInfoKey"));
        }
        addTypeAPI(streamBoxInfoKeyTypeAPI);
        factory = factoryOverrides.get("StreamBoxInfoKey");
        if(factory == null)
            factory = new StreamBoxInfoKeyHollowFactory();
        if(cachedTypes.contains("StreamBoxInfoKey")) {
            HollowObjectCacheProvider previousCacheProvider = null;
            if(previousCycleAPI != null && (previousCycleAPI.streamBoxInfoKeyProvider instanceof HollowObjectCacheProvider))
                previousCacheProvider = (HollowObjectCacheProvider) previousCycleAPI.streamBoxInfoKeyProvider;
            streamBoxInfoKeyProvider = new HollowObjectCacheProvider(typeDataAccess, streamBoxInfoKeyTypeAPI, factory, previousCacheProvider);
        } else {
            streamBoxInfoKeyProvider = new HollowObjectFactoryProvider(typeDataAccess, streamBoxInfoKeyTypeAPI, factory);
        }

        typeDataAccess = dataAccess.getTypeDataAccess("StreamBoxInfo");
        if(typeDataAccess != null) {
            streamBoxInfoTypeAPI = new StreamBoxInfoTypeAPI(this, (HollowObjectTypeDataAccess)typeDataAccess);
        } else {
            streamBoxInfoTypeAPI = new StreamBoxInfoTypeAPI(this, new HollowObjectMissingDataAccess(dataAccess, "StreamBoxInfo"));
        }
        addTypeAPI(streamBoxInfoTypeAPI);
        factory = factoryOverrides.get("StreamBoxInfo");
        if(factory == null)
            factory = new StreamBoxInfoHollowFactory();
        if(cachedTypes.contains("StreamBoxInfo")) {
            HollowObjectCacheProvider previousCacheProvider = null;
            if(previousCycleAPI != null && (previousCycleAPI.streamBoxInfoProvider instanceof HollowObjectCacheProvider))
                previousCacheProvider = (HollowObjectCacheProvider) previousCycleAPI.streamBoxInfoProvider;
            streamBoxInfoProvider = new HollowObjectCacheProvider(typeDataAccess, streamBoxInfoTypeAPI, factory, previousCacheProvider);
        } else {
            streamBoxInfoProvider = new HollowObjectFactoryProvider(typeDataAccess, streamBoxInfoTypeAPI, factory);
        }

        typeDataAccess = dataAccess.getTypeDataAccess("SetOfStreamBoxInfo");
        if(typeDataAccess != null) {
            setOfStreamBoxInfoTypeAPI = new SetOfStreamBoxInfoTypeAPI(this, (HollowSetTypeDataAccess)typeDataAccess);
        } else {
            setOfStreamBoxInfoTypeAPI = new SetOfStreamBoxInfoTypeAPI(this, new HollowSetMissingDataAccess(dataAccess, "SetOfStreamBoxInfo"));
        }
        addTypeAPI(setOfStreamBoxInfoTypeAPI);
        factory = factoryOverrides.get("SetOfStreamBoxInfo");
        if(factory == null)
            factory = new SetOfStreamBoxInfoHollowFactory();
        if(cachedTypes.contains("SetOfStreamBoxInfo")) {
            HollowObjectCacheProvider previousCacheProvider = null;
            if(previousCycleAPI != null && (previousCycleAPI.setOfStreamBoxInfoProvider instanceof HollowObjectCacheProvider))
                previousCacheProvider = (HollowObjectCacheProvider) previousCycleAPI.setOfStreamBoxInfoProvider;
            setOfStreamBoxInfoProvider = new HollowObjectCacheProvider(typeDataAccess, setOfStreamBoxInfoTypeAPI, factory, previousCacheProvider);
        } else {
            setOfStreamBoxInfoProvider = new HollowObjectFactoryProvider(typeDataAccess, setOfStreamBoxInfoTypeAPI, factory);
        }

        typeDataAccess = dataAccess.getTypeDataAccess("DashStreamHeaderData");
        if(typeDataAccess != null) {
            dashStreamHeaderDataTypeAPI = new DashStreamHeaderDataTypeAPI(this, (HollowObjectTypeDataAccess)typeDataAccess);
        } else {
            dashStreamHeaderDataTypeAPI = new DashStreamHeaderDataTypeAPI(this, new HollowObjectMissingDataAccess(dataAccess, "DashStreamHeaderData"));
        }
        addTypeAPI(dashStreamHeaderDataTypeAPI);
        factory = factoryOverrides.get("DashStreamHeaderData");
        if(factory == null)
            factory = new DashStreamHeaderDataHollowFactory();
        if(cachedTypes.contains("DashStreamHeaderData")) {
            HollowObjectCacheProvider previousCacheProvider = null;
            if(previousCycleAPI != null && (previousCycleAPI.dashStreamHeaderDataProvider instanceof HollowObjectCacheProvider))
                previousCacheProvider = (HollowObjectCacheProvider) previousCycleAPI.dashStreamHeaderDataProvider;
            dashStreamHeaderDataProvider = new HollowObjectCacheProvider(typeDataAccess, dashStreamHeaderDataTypeAPI, factory, previousCacheProvider);
        } else {
            dashStreamHeaderDataProvider = new HollowObjectFactoryProvider(typeDataAccess, dashStreamHeaderDataTypeAPI, factory);
        }
        ...
        typeDataAccess = dataAccess.getTypeDataAccess("TimecodedMomentAnnotation");
        if(typeDataAccess != null) {
            timecodedMomentAnnotationTypeAPI = new TimecodedMomentAnnotationTypeAPI(this, (HollowObjectTypeDataAccess)typeDataAccess);
        } else {
            timecodedMomentAnnotationTypeAPI = new TimecodedMomentAnnotationTypeAPI(this, new HollowObjectMissingDataAccess(dataAccess, "TimecodedMomentAnnotation"));
        }
        addTypeAPI(timecodedMomentAnnotationTypeAPI);
        factory = factoryOverrides.get("TimecodedMomentAnnotation");
        if(factory == null)
            factory = new TimecodedMomentAnnotationHollowFactory();
        if(cachedTypes.contains("TimecodedMomentAnnotation")) {
            HollowObjectCacheProvider previousCacheProvider = null;
            if(previousCycleAPI != null && (previousCycleAPI.timecodedMomentAnnotationProvider instanceof HollowObjectCacheProvider))
                previousCacheProvider = (HollowObjectCacheProvider) previousCycleAPI.timecodedMomentAnnotationProvider;
            timecodedMomentAnnotationProvider = new HollowObjectCacheProvider(typeDataAccess, timecodedMomentAnnotationTypeAPI, factory, previousCacheProvider);
        } else {
            timecodedMomentAnnotationProvider = new HollowObjectFactoryProvider(typeDataAccess, timecodedMomentAnnotationTypeAPI, factory);
        }

        typeDataAccess = dataAccess.getTypeDataAccess("TimecodeAnnotationsList");
        if(typeDataAccess != null) {
            timecodeAnnotationsListTypeAPI = new TimecodeAnnotationsListTypeAPI(this, (HollowListTypeDataAccess)typeDataAccess);
        } else {
            timecodeAnnotationsListTypeAPI = new TimecodeAnnotationsListTypeAPI(this, new HollowListMissingDataAccess(dataAccess, "TimecodeAnnotationsList"));
        }
        addTypeAPI(timecodeAnnotationsListTypeAPI);
        factory = factoryOverrides.get("TimecodeAnnotationsList");
        if(factory == null)
            factory = new TimecodeAnnotationsListHollowFactory();
        if(cachedTypes.contains("TimecodeAnnotationsList")) {
            HollowObjectCacheProvider previousCacheProvider = null;
            if(previousCycleAPI != null && (previousCycleAPI.timecodeAnnotationsListProvider instanceof HollowObjectCacheProvider))
                previousCacheProvider = (HollowObjectCacheProvider) previousCycleAPI.timecodeAnnotationsListProvider;
            timecodeAnnotationsListProvider = new HollowObjectCacheProvider(typeDataAccess, timecodeAnnotationsListTypeAPI, factory, previousCacheProvider);
        } else {
            timecodeAnnotationsListProvider = new HollowObjectFactoryProvider(typeDataAccess, timecodeAnnotationsListTypeAPI, factory);
        }

        typeDataAccess = dataAccess.getTypeDataAccess("TimecodeAnnotation");
        if(typeDataAccess != null) {
            timecodeAnnotationTypeAPI = new TimecodeAnnotationTypeAPI(this, (HollowObjectTypeDataAccess)typeDataAccess);
        } else {
            timecodeAnnotationTypeAPI = new TimecodeAnnotationTypeAPI(this, new HollowObjectMissingDataAccess(dataAccess, "TimecodeAnnotation"));
        }
        addTypeAPI(timecodeAnnotationTypeAPI);
        factory = factoryOverrides.get("TimecodeAnnotation");
        if(factory == null)
            factory = new TimecodeAnnotationHollowFactory();
        if(cachedTypes.contains("TimecodeAnnotation")) {
            HollowObjectCacheProvider previousCacheProvider = null;
            if(previousCycleAPI != null && (previousCycleAPI.timecodeAnnotationProvider instanceof HollowObjectCacheProvider))
                previousCacheProvider = (HollowObjectCacheProvider) previousCycleAPI.timecodeAnnotationProvider;
            timecodeAnnotationProvider = new HollowObjectCacheProvider(typeDataAccess, timecodeAnnotationTypeAPI, factory, previousCacheProvider);
        } else {
            timecodeAnnotationProvider = new HollowObjectFactoryProvider(typeDataAccess, timecodeAnnotationTypeAPI, factory);
        }
    ...
    public void detachCaches() {
        ...
        if(streamBoxInfoKeyProvider instanceof HollowObjectCacheProvider)
            ((HollowObjectCacheProvider)streamBoxInfoKeyProvider).detach();
        if(streamBoxInfoProvider instanceof HollowObjectCacheProvider)
            ((HollowObjectCacheProvider)streamBoxInfoProvider).detach();
        if(setOfStreamBoxInfoProvider instanceof HollowObjectCacheProvider)
            ((HollowObjectCacheProvider)setOfStreamBoxInfoProvider).detach();
        if(dashStreamHeaderDataProvider instanceof HollowObjectCacheProvider)
            ((HollowObjectCacheProvider)dashStreamHeaderDataProvider).detach();
        ...
        if(timecodedMomentAnnotationProvider instanceof HollowObjectCacheProvider)
            ((HollowObjectCacheProvider)timecodedMomentAnnotationProvider).detach();
        if(timecodeAnnotationsListProvider instanceof HollowObjectCacheProvider)
            ((HollowObjectCacheProvider)timecodeAnnotationsListProvider).detach();
        if(timecodeAnnotationProvider instanceof HollowObjectCacheProvider)
            ((HollowObjectCacheProvider)timecodeAnnotationProvider).detach();
    ...
    public StreamBoxInfoKeyTypeAPI getStreamBoxInfoKeyTypeAPI() {
        return streamBoxInfoKeyTypeAPI;
    }
    public StreamBoxInfoTypeAPI getStreamBoxInfoTypeAPI() {
        return streamBoxInfoTypeAPI;
    }
    public SetOfStreamBoxInfoTypeAPI getSetOfStreamBoxInfoTypeAPI() {
        return setOfStreamBoxInfoTypeAPI;
    }
    public DashStreamHeaderDataTypeAPI getDashStreamHeaderDataTypeAPI() {
        return dashStreamHeaderDataTypeAPI;
    }
    ...
    public TimecodedMomentAnnotationTypeAPI getTimecodedMomentAnnotationTypeAPI() {
        return timecodedMomentAnnotationTypeAPI;
    }
    public TimecodeAnnotationsListTypeAPI getTimecodeAnnotationsListTypeAPI() {
        return timecodeAnnotationsListTypeAPI;
    }
    public TimecodeAnnotationTypeAPI getTimecodeAnnotationTypeAPI() {
        return timecodeAnnotationTypeAPI;
    }
    ...
    public Collection<StreamBoxInfoKeyHollow> getAllStreamBoxInfoKeyHollow() {
        return new AllHollowRecordCollection<StreamBoxInfoKeyHollow>(getDataAccess().getTypeDataAccess("StreamBoxInfoKey").getTypeState()) {
            protected StreamBoxInfoKeyHollow getForOrdinal(int ordinal) {
                return getStreamBoxInfoKeyHollow(ordinal);
            }
        };
    }
    public StreamBoxInfoKeyHollow getStreamBoxInfoKeyHollow(int ordinal) {
        objectCreationSampler.recordCreation(35);
        return (StreamBoxInfoKeyHollow)streamBoxInfoKeyProvider.getHollowObject(ordinal);
    }
    public Collection<StreamBoxInfoHollow> getAllStreamBoxInfoHollow() {
        return new AllHollowRecordCollection<StreamBoxInfoHollow>(getDataAccess().getTypeDataAccess("StreamBoxInfo").getTypeState()) {
            protected StreamBoxInfoHollow getForOrdinal(int ordinal) {
                return getStreamBoxInfoHollow(ordinal);
            }
        };
    }
    public StreamBoxInfoHollow getStreamBoxInfoHollow(int ordinal) {
        objectCreationSampler.recordCreation(36);
        return (StreamBoxInfoHollow)streamBoxInfoProvider.getHollowObject(ordinal);
    }
    public Collection<SetOfStreamBoxInfoHollow> getAllSetOfStreamBoxInfoHollow() {
        return new AllHollowRecordCollection<SetOfStreamBoxInfoHollow>(getDataAccess().getTypeDataAccess("SetOfStreamBoxInfo").getTypeState()) {
            protected SetOfStreamBoxInfoHollow getForOrdinal(int ordinal) {
                return getSetOfStreamBoxInfoHollow(ordinal);
            }
        };
    }
    public SetOfStreamBoxInfoHollow getSetOfStreamBoxInfoHollow(int ordinal) {
        objectCreationSampler.recordCreation(37);
        return (SetOfStreamBoxInfoHollow)setOfStreamBoxInfoProvider.getHollowObject(ordinal);
    }
    public Collection<DashStreamHeaderDataHollow> getAllDashStreamHeaderDataHollow() {
        return new AllHollowRecordCollection<DashStreamHeaderDataHollow>(getDataAccess().getTypeDataAccess("DashStreamHeaderData").getTypeState()) {
            protected DashStreamHeaderDataHollow getForOrdinal(int ordinal) {
                return getDashStreamHeaderDataHollow(ordinal);
            }
        };
    }
    public DashStreamHeaderDataHollow getDashStreamHeaderDataHollow(int ordinal) {
        objectCreationSampler.recordCreation(38);
        return (DashStreamHeaderDataHollow)dashStreamHeaderDataProvider.getHollowObject(ordinal);
    }
    ...
    public Collection<CinderCupTokenRecordHollow> getAllCinderCupTokenRecordHollow() {
        return new AllHollowRecordCollection<CinderCupTokenRecordHollow>(getDataAccess().getTypeDataAccess("CinderCupTokenRecord").getTypeState()) {
            protected CinderCupTokenRecordHollow getForOrdinal(int ordinal) {
                return getCinderCupTokenRecordHollow(ordinal);
            }
        };
    }
    public CinderCupTokenRecordHollow getCinderCupTokenRecordHollow(int ordinal) {
        objectCreationSampler.recordCreation(58);
        return (CinderCupTokenRecordHollow)cinderCupTokenRecordProvider.getHollowObject(ordinal);
    }
    ...
    public Collection<MapOfStringToLongHollow> getAllMapOfStringToLongHollow() {
        return new AllHollowRecordCollection<MapOfStringToLongHollow>(getDataAccess().getTypeDataAccess("MapOfStringToLong").getTypeState()) {
            protected MapOfStringToLongHollow getForOrdinal(int ordinal) {
                return getMapOfStringToLongHollow(ordinal);
            }
        };
    }
    public MapOfStringToLongHollow getMapOfStringToLongHollow(int ordinal) {
        objectCreationSampler.recordCreation(82);
        return (MapOfStringToLongHollow)mapOfStringToLongProvider.getHollowObject(ordinal);
    }
    public Collection<FeedMovieCountryLanguagesHollow> getAllFeedMovieCountryLanguagesHollow() {
        return new AllHollowRecordCollection<FeedMovieCountryLanguagesHollow>(getDataAccess().getTypeDataAccess("FeedMovieCountryLanguages").getTypeState()) {
            protected FeedMovieCountryLanguagesHollow getForOrdinal(int ordinal) {
                return getFeedMovieCountryLanguagesHollow(ordinal);
            }
        };
    }
    public FeedMovieCountryLanguagesHollow getFeedMovieCountryLanguagesHollow(int ordinal) {
        objectCreationSampler.recordCreation(83);
        return (FeedMovieCountryLanguagesHollow)feedMovieCountryLanguagesProvider.getHollowObject(ordinal);
    }
    ...
    public Collection<TimecodedMomentAnnotationHollow> getAllTimecodedMomentAnnotationHollow() {
        return new AllHollowRecordCollection<TimecodedMomentAnnotationHollow>(getDataAccess().getTypeDataAccess("TimecodedMomentAnnotation").getTypeState()) {
            protected TimecodedMomentAnnotationHollow getForOrdinal(int ordinal) {
                return getTimecodedMomentAnnotationHollow(ordinal);
            }
        };
    }
    public TimecodedMomentAnnotationHollow getTimecodedMomentAnnotationHollow(int ordinal) {
        objectCreationSampler.recordCreation(139);
        return (TimecodedMomentAnnotationHollow)timecodedMomentAnnotationProvider.getHollowObject(ordinal);
    }
    public Collection<TimecodeAnnotationsListHollow> getAllTimecodeAnnotationsListHollow() {
        return new AllHollowRecordCollection<TimecodeAnnotationsListHollow>(getDataAccess().getTypeDataAccess("TimecodeAnnotationsList").getTypeState()) {
            protected TimecodeAnnotationsListHollow getForOrdinal(int ordinal) {
                return getTimecodeAnnotationsListHollow(ordinal);
            }
        };
    }
    public TimecodeAnnotationsListHollow getTimecodeAnnotationsListHollow(int ordinal) {
        objectCreationSampler.recordCreation(140);
        return (TimecodeAnnotationsListHollow)timecodeAnnotationsListProvider.getHollowObject(ordinal);
    }
    public Collection<TimecodeAnnotationHollow> getAllTimecodeAnnotationHollow() {
        return new AllHollowRecordCollection<TimecodeAnnotationHollow>(getDataAccess().getTypeDataAccess("TimecodeAnnotation").getTypeState()) {
            protected TimecodeAnnotationHollow getForOrdinal(int ordinal) {
                return getTimecodeAnnotationHollow(ordinal);
            }
        };
    }
    public TimecodeAnnotationHollow getTimecodeAnnotationHollow(int ordinal) {
        objectCreationSampler.recordCreation(141);
        return (TimecodeAnnotationHollow)timecodeAnnotationProvider.getHollowObject(ordinal);
    }
