...
public class DownloadableIdUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public DownloadableIdUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
