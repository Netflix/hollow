...
public class DisallowedSubtitleLangCodeUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public DisallowedSubtitleLangCodeUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
