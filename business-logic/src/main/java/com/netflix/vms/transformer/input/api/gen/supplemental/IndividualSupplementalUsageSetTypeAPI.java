...
public class IndividualSupplementalUsageSetTypeAPI extends HollowSetTypeAPI {

    private final HollowSetLookupDelegate delegateLookupImpl;

    public IndividualSupplementalUsageSetTypeAPI(SupplementalAPI api, HollowSetTypeDataAccess dataAccess) {
