...
public class CharacterUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public CharacterUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
