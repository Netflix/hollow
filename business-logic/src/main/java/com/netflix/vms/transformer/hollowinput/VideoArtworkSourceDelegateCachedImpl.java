...
public class VideoArtworkSourceDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, VideoArtworkSourceDelegate {
   ...
   private VideoArtworkSourceTypeAPI typeAPI;

    public VideoArtworkSourceDelegateCachedImpl(VideoArtworkSourceTypeAPI typeAPI, int ordinal) {
    ...
    public VideoArtworkSourceTypeAPI getTypeAPI() {
        return typeAPI;
    }

    public void updateTypeAPI(HollowTypeAPI typeAPI) {
        this.typeAPI = (VideoArtworkSourceTypeAPI) typeAPI;
    }
