...
public class StringDataAccessor extends AbstractHollowDataAccessor<HString> {
    ...
    public StringDataAccessor(HollowReadStateEngine rStateEngine, MceImageV3API api) {
        super(rStateEngine, TYPE);
        this.api = api;
    }

    public StringDataAccessor(HollowReadStateEngine rStateEngine, MceImageV3API api, String ... fieldPaths) {
        super(rStateEngine, TYPE, fieldPaths);
        this.api = api;
    }

    public StringDataAccessor(HollowReadStateEngine rStateEngine, MceImageV3API api, PrimaryKey primaryKey) {
