...
public class DrmHeaderInfoUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public DrmHeaderInfoUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
