...
public class PersonVideoAliasIdUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public PersonVideoAliasIdUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
