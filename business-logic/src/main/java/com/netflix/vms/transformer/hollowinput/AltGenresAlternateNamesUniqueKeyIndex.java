...
public class AltGenresAlternateNamesUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public AltGenresAlternateNamesUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
