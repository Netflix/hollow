...
public class CupTokenAPIHashIndex extends AbstractHollowHashIndex<CupTokenAPI> {

    public CupTokenAPIHashIndex(HollowConsumer consumer, String queryType, String selectFieldPath, String... matchFieldPaths) {
        super(consumer, true, queryType, selectFieldPath, matchFieldPaths);
    }

    public CupTokenAPIHashIndex(HollowConsumer consumer, boolean isListenToDataRefresh, String queryType, String selectFieldPath, String... matchFieldPaths) {
    ...
    public Iterable<CinderCupTokenRecord> findCinderCupTokenRecordMatches(Object... keys) {
        HollowHashIndexResult matches = idx.findMatches(keys);
        if(matches == null) return Collections.emptySet();

        return new AbstractHollowOrdinalIterable<CinderCupTokenRecord>(matches.iterator()) {
            public CinderCupTokenRecord getData(int ordinal) {
