...
public class TranslatedTextValueUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public TranslatedTextValueUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
