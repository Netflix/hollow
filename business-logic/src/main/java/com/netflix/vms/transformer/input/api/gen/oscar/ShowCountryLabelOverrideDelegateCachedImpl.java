...
public class ShowCountryLabelOverrideDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, ShowCountryLabelOverrideDelegate {
    ...
    private ShowCountryLabelOverrideTypeAPI typeAPI;

    public ShowCountryLabelOverrideDelegateCachedImpl(ShowCountryLabelOverrideTypeAPI typeAPI, int ordinal) {
    ...
    public void updateTypeAPI(HollowTypeAPI typeAPI) {
        this.typeAPI = (ShowCountryLabelOverrideTypeAPI) typeAPI;
    }
