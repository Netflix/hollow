...
public class CacheDeploymentIntentUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public CacheDeploymentIntentUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
