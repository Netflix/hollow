...
public class VideoGeneralTitleTypeUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public VideoGeneralTitleTypeUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
