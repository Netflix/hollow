...
public class LocaleTerritoryCodeUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public LocaleTerritoryCodeUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
