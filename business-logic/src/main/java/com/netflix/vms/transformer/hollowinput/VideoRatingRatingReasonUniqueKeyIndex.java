...
public class VideoRatingRatingReasonUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public VideoRatingRatingReasonUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
