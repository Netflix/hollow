...
public class VideoGeneralTitleTypePrimaryKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public VideoGeneralTitleTypePrimaryKeyIndex(HollowConsumer consumer) {
        this(consumer, ((HollowObjectSchema)consumer.getStateEngine().getSchema("VideoGeneralTitleType")).getPrimaryKey().getFieldPaths());
    }
    ...
    public VideoGeneralTitleTypePrimaryKeyIndex(HollowConsumer consumer, String... fieldPaths) {
        ...
        try {
            ...
            this.idx = new HollowPrimaryKeyIndex(consumer.getStateEngine(), "VideoGeneralTitleType", fieldPaths);
