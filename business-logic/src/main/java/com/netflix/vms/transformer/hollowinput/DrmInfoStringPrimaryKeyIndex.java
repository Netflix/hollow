...
public class DrmInfoStringPrimaryKeyIndex extends AbstractHollowUniqueKeyIndex<VMSHollowInputAPI, DrmInfoStringHollow> {
    ...
    public DrmInfoStringPrimaryKeyIndex(HollowConsumer consumer, boolean isListenToDataRefreah) {
        this(consumer, isListenToDataRefreah, ((HollowObjectSchema)consumer.getStateEngine().getSchema("DrmInfoString")).getPrimaryKey().getFieldPaths());
    }
