...
public class MovieCountriesNotOriginal extends HollowObject {

    public MovieCountriesNotOriginal(MovieCountriesNotOriginalDelegate delegate, int ordinal) {
    ...
    public String getCountries() {
        return delegate().getCountries(ordinal);
    }

    public boolean isCountriesEqual(String testValue) {
        return delegate().isCountriesEqual(ordinal, testValue);
    }

    public CountryString getCountriesHollowReference() {
    ...
    public MovieCountriesNotOriginalTypeAPI typeApi() {
        return delegate().getTypeAPI();
    }

    protected MovieCountriesNotOriginalDelegate delegate() {
        return (MovieCountriesNotOriginalDelegate)delegate;
    }

    /**
     * Creates a unique key index for {@code MovieCountriesNotOriginal} that has a primary key.
     ...
     */
    public static UniqueKeyIndex<MovieCountriesNotOriginal, Long> uniqueIndex(HollowConsumer consumer) {
        return UniqueKeyIndex.from(consumer, MovieCountriesNotOriginal.class)
            .bindToPrimaryKey()
