...
public class VideoRatingAdvisoriesUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public VideoRatingAdvisoriesUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
