...
public class ArtWorkImageTypeUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public ArtWorkImageTypeUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
