...
public class VideoRatingAdvisoryIdUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public VideoRatingAdvisoryIdUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
