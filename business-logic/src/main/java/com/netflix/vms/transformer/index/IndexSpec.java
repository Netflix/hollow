...
public enum IndexSpec {
    ...
    VIDEO_CONTRACTS(HASH, "Contracts", "", "movieId", "countryCode"),
    VIDEO_CONTRACT_BY_CONTRACTID(HASH, "Contracts", "contracts.element", "movieId", "countryCode", "contracts.element.contractId"),
