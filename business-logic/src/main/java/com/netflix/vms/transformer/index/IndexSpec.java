...
public enum IndexSpec {
    ...
    VIDEO_CONTRACT_BY_CONTRACTID(HASH, "Contracts", "contracts.element", "movieId", "countryCode.value", "contracts.element.dealId"),
    ...
    CUP_TOKEN_HASH(HASH, "CinderCupTokenRecord", "", "movieId.value", "dealId.value"),    
