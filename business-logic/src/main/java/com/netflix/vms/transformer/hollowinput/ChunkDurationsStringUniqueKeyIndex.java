...
public class ChunkDurationsStringUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public ChunkDurationsStringUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
