...
public class CSMReviewDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, CSMReviewDelegate {
    ...
    private final int plasticReleaseDateOrdinal;
    ...
    private final int releaseDateOrdinal;
   ...
   private CSMReviewTypeAPI typeAPI;
    ...
    public CSMReviewDelegateCachedImpl(CSMReviewTypeAPI typeAPI, int ordinal) {
        ...
        this.plasticReleaseDateOrdinal = typeAPI.getPlasticReleaseDateOrdinal(ordinal);
        ...
        this.releaseDateOrdinal = typeAPI.getReleaseDateOrdinal(ordinal);
    ...
    public int getPlasticReleaseDateOrdinal(int ordinal) {
        return plasticReleaseDateOrdinal;
    }
