...
public class PersonBioUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public PersonBioUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
