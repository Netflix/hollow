...
public class RightsAssetPrimaryKeyIndex implements HollowConsumer.RefreshListener {
    ...
    public RightsAssetPrimaryKeyIndex(HollowConsumer consumer, String... fieldPaths) {
        ...
        try {
            ...
            this.idx = new HollowPrimaryKeyIndex(consumer.getStateEngine(), "RightsAsset", fieldPaths);
