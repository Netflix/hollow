...
public class StreamDeploymentInfoUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public StreamDeploymentInfoUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
