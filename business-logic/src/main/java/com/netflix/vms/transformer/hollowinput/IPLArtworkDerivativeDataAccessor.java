...
public class IPLArtworkDerivativeDataAccessor extends AbstractHollowDataAccessor<IPLArtworkDerivativeHollow> {
    ...
    public IPLArtworkDerivativeDataAccessor(HollowReadStateEngine rStateEngine, VMSHollowInputAPI api) {
        super(rStateEngine, TYPE);
        this.api = api;
    }

    public IPLArtworkDerivativeDataAccessor(HollowReadStateEngine rStateEngine, VMSHollowInputAPI api, String ... fieldPaths) {
        super(rStateEngine, TYPE, fieldPaths);
        this.api = api;
    }

    public IPLArtworkDerivativeDataAccessor(HollowReadStateEngine rStateEngine, VMSHollowInputAPI api, PrimaryKey primaryKey) {
