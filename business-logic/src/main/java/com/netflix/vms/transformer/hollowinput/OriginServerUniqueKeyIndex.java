...
public class OriginServerUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public OriginServerUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
