...
public class IPLArtworkDerivativeSetUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public IPLArtworkDerivativeSetUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
