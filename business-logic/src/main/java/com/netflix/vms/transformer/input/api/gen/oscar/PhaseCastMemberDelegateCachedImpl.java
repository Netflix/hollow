...
public class PhaseCastMemberDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, PhaseCastMemberDelegate {

    private final Long personId;
    private final int personIdOrdinal;
    ...
    private PhaseCastMemberTypeAPI typeAPI;

    public PhaseCastMemberDelegateCachedImpl(PhaseCastMemberTypeAPI typeAPI, int ordinal) {
        this.personIdOrdinal = typeAPI.getPersonIdOrdinal(ordinal);
        int personIdTempOrdinal = personIdOrdinal;
        this.personId = personIdTempOrdinal == -1 ? null : typeAPI.getAPI().getPersonIdTypeAPI().getValue(personIdTempOrdinal);
    ...
    public void updateTypeAPI(HollowTypeAPI typeAPI) {
        this.typeAPI = (PhaseCastMemberTypeAPI) typeAPI;
    }
