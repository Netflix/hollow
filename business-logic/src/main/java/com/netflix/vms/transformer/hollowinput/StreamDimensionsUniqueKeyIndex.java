...
public class StreamDimensionsUniqueKeyIndex implements HollowConsumer.RefreshListener {

    private HollowPrimaryKeyIndex idx;
    private VMSHollowInputAPI api;

    public StreamDimensionsUniqueKeyIndex(HollowConsumer consumer, String... fieldPaths) {
