...
public class CharacterArtworkSourceTypeAPI extends HollowObjectTypeAPI {
    ...
    public CharacterArtworkSourceTypeAPI(VMSHollowInputAPI api, HollowObjectTypeDataAccess typeDataAccess) {
        ...
        this.delegateLookupImpl = new CharacterArtworkSourceDelegateLookupImpl(this);
    }

    public int getSourceFileIdOrdinal(int ordinal) {
        if(fieldIndex[0] == -1)
            return missingDataHandler().handleReferencedOrdinal("CharacterArtworkSource", ordinal, "sourceFileId");
    ...
    public long getCharacterId(int ordinal) {
        if(fieldIndex[1] == -1)
            return missingDataHandler().handleLong("CharacterArtworkSource", ordinal, "characterId");
    ...
    public Long getCharacterIdBoxed(int ordinal) {
        long l;
        if(fieldIndex[1] == -1) {
            l = missingDataHandler().handleLong("CharacterArtworkSource", ordinal, "characterId");
        } else {
    ...
    public boolean getIsFallback(int ordinal) {
        if(fieldIndex[2] == -1)
            return missingDataHandler().handleBoolean("CharacterArtworkSource", ordinal, "isFallback") == Boolean.TRUE;
        return getTypeDataAccess().readBoolean(ordinal, fieldIndex[2]) == Boolean.TRUE;
    }

    public Boolean getIsFallbackBoxed(int ordinal) {
        if(fieldIndex[2] == -1)
            return missingDataHandler().handleBoolean("CharacterArtworkSource", ordinal, "isFallback");
    ...
    public int getFallbackSourceFileIdOrdinal(int ordinal) {
        if(fieldIndex[3] == -1)
            return missingDataHandler().handleReferencedOrdinal("CharacterArtworkSource", ordinal, "fallbackSourceFileId");
    ...
    public int getSeqNum(int ordinal) {
        if(fieldIndex[4] == -1)
            return missingDataHandler().handleInt("CharacterArtworkSource", ordinal, "seqNum");
    ...
    public Integer getSeqNumBoxed(int ordinal) {
        int i;
        if(fieldIndex[4] == -1) {
            i = missingDataHandler().handleInt("CharacterArtworkSource", ordinal, "seqNum");
        } else {
    ...
    public int getOrdinalPriority(int ordinal) {
        if(fieldIndex[5] == -1)
            return missingDataHandler().handleInt("CharacterArtworkSource", ordinal, "ordinalPriority");
    ...
    public Integer getOrdinalPriorityBoxed(int ordinal) {
        int i;
        if(fieldIndex[5] == -1) {
            i = missingDataHandler().handleInt("CharacterArtworkSource", ordinal, "ordinalPriority");
        } else {
    ...
    public int getFileImageTypeOrdinal(int ordinal) {
        if(fieldIndex[6] == -1)
            return missingDataHandler().handleReferencedOrdinal("CharacterArtworkSource", ordinal, "fileImageType");
    ...
    public int getPhaseTagsOrdinal(int ordinal) {
        if(fieldIndex[7] == -1)
            return missingDataHandler().handleReferencedOrdinal("CharacterArtworkSource", ordinal, "phaseTags");
    ...
    public boolean getIsSmoky(int ordinal) {
        if(fieldIndex[8] == -1)
            return missingDataHandler().handleBoolean("CharacterArtworkSource", ordinal, "isSmoky") == Boolean.TRUE;
        return getTypeDataAccess().readBoolean(ordinal, fieldIndex[8]) == Boolean.TRUE;
    }

    public Boolean getIsSmokyBoxed(int ordinal) {
        if(fieldIndex[8] == -1)
            return missingDataHandler().handleBoolean("CharacterArtworkSource", ordinal, "isSmoky");
    ...
    public boolean getRolloutExclusive(int ordinal) {
        if(fieldIndex[9] == -1)
            return missingDataHandler().handleBoolean("CharacterArtworkSource", ordinal, "rolloutExclusive") == Boolean.TRUE;
    ...
    public Boolean getRolloutExclusiveBoxed(int ordinal) {
        if(fieldIndex[9] == -1)
            return missingDataHandler().handleBoolean("CharacterArtworkSource", ordinal, "rolloutExclusive");
    ...
    public int getAttributesOrdinal(int ordinal) {
        if(fieldIndex[10] == -1)
            return missingDataHandler().handleReferencedOrdinal("CharacterArtworkSource", ordinal, "attributes");
    ...
    public int getLocalesOrdinal(int ordinal) {
        if(fieldIndex[11] == -1)
            return missingDataHandler().handleReferencedOrdinal("CharacterArtworkSource", ordinal, "locales");
    ...
    public CharacterArtworkSourceDelegateLookupImpl getDelegateLookupImpl() {
