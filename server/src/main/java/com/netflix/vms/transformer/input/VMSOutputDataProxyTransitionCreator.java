...
public class VMSOutputDataProxyTransitionCreator implements HollowBlobRetriever {

    private static final Logger LOGGER = LoggerFactory.getLogger(VMSOutputDataProxyTransitionCreator.class);

    private final String baseProxyURL;
    private final String localDataDir;
    private final KeybaseBuilder keybaseBuilder;

    public VMSOutputDataProxyTransitionCreator(String baseProxyURL, String localDataDir, String converterVip) {
        this(baseProxyURL, localDataDir, new VMSInputDataKeybaseBuilder(converterVip));
    }
    
    public VMSOutputDataProxyTransitionCreator(String baseProxyURL, String localDataDir, KeybaseBuilder keybaseBuilder) {
