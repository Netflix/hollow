...
public class VMSInputDataTransitionCreator implements HollowBlobRetriever {
    ...
    public VMSInputDataTransitionCreator(FileStore fileStore, KeybaseBuilder keybaseBuilder) {
