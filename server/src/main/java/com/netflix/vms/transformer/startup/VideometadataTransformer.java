 ...
 */
public class VideometadataTransformer implements WebApplicationInitializer {

    public static void main(String[] args) throws Exception {
        InjectorBuilder.fromModules(
                new VideometadataTransformerModule(),
                new JettyModule(),
                new ArchaiusModule() {
                    @Override
    ...
    public Injector createInjector() {
        return InjectorBuilder.fromModules(new VideometadataTransformerModule()).createInjector();
    }
}
