            ...
            .widget(
                    "ui.mouse",
                    {
                        ...
                        _mouseDown : function(event) {
                            ...
                            elIsCancel = (typeof this.options.cancel === "string" && event.target.nodeName ? $(event.target).closest(this.options.cancel).length
                                    : false);
...
(function($, undefined) {
    ...
    $.fn.position = function(options) {
        ...
        var atOffset, targetWidth, targetHeight, targetOffset, basePosition, dimensions, target = $(options.of), within = $.position
                .getWithinInfo(options.within), scrollInfo = $.position.getScrollInfo(within), collision = (options.collision || "flip").split(" "), offsets = {};
        ...
        return this
                .each(function() {
                    var collisionPosition, using, elem = $(this), elemWidth = elem.outerWidth(), elemHeight = elem.outerHeight(), marginLeft = parseCss(
                            ...
                            + parseCss(this, "marginRight") + scrollInfo.width, collisionHeight = elemHeight + marginTop + parseCss(this, "marginBottom")
                            + scrollInfo.height, position = $.extend({}, basePosition), myOffset = getOffsets(offsets.my, elem.outerWidth(), elem
                            .outerHeight());
...
(function($, undefined) {
    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _mouseStart : function(event) {
            ...
            /*
             * - Position generation - This block generates everything position related - it's the
             * core of draggables.
             */
            ...
            // This is a relative to absolute position minus the actual position calculation - only
            // used for relative positioned helper
            });
        ...
        _convertPositionTo : function(d, pos) {
            ...
            var mod = d === "absolute" ? 1 : -1, scroll = this.cssPosition === "absolute"
                    && !(this.scrollParent[0] !== document && $.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent
                    : this.scrollParent;
        ...
        _generatePosition : function(event) {
            ...
            return {
                ...
                this.offset.relative.top - // Only for relative positioned nodes: Relative offset
                // from element to offset parent
                this.offset.parent.top + // The offsetParent's offset without borders (offset +
                // border)
                (this.cssPosition === "fixed" ? -this.scrollParent.scrollTop() : this.offset.scroll.top)),
                left : (pageX - // The absolute mouse position
                this.offset.click.left - // Click offset (relative to the element)
                this.offset.relative.left - // Only for relative positioned nodes: Relative offset
                // from element to offset parent
                this.offset.parent.left + // The offsetParent's offset without borders (offset +
                // border)
        ...
        start : function(event, ui) {
            ...
            $(o.connectToSortable).each(function() {
                ...
                if (sortable && !sortable.options.disabled) {
                    ...
                    sortable.refreshPositions(); // Call the sortable's refreshPositions at drag
                    // start to refresh the containerCache since the
                    // sortable container cache is used in drag and
                    // needs to be up to date (this will ensure it's
                    // initialised as well as being kept in step
        ...
        stop : function(event, ui) {
            ...
            $.each(inst.sortables, function() {
                if (this.instance.isOver) {
                    ...
                    // instance (so sortable plugins
                    // like revert still work)

                    // The sortable revert is supported, and we have to set a temporary dropped
        ...
        drag : function(event, ui) {
            ...
            $.each(inst.sortables, function() {
                ...
                if (innermostIntersecting) {
                    // If it intersects, we use a little isOver variable and set it once, so our
                    // move-in stuff gets fired only once
                    if (!this.instance.isOver) {

                        this.instance.isOver = 1;
                        // Now we fake the start of dragging for the sortable instance,
                        // by cloning the list group item, appending it to the sortable and using it
                        // as inst.currentItem
                        // We can then fire the start event of the sortable with our passed browser
                        // event, and our own helper (so it doesn't create a new one)
                        ...
                        // Because the browser event is way off the new appended portlet, we modify
                        // a couple of variables to reflect the changes
                    ...
                    // Provided we did all the previous steps, we can fire the drag event of the
                    // sortable on every draggable drag, when it intersects with the sortable
                    ...
                    if (this.instance.isOver) {
                        ...
                        // Now we remove our currentItem, the list group clone again, and the
                        // placeholder, and animate the helper back to it's original size
...
(function($, undefined) {
    ...
    $.ui.intersect = function(draggable, droppable, toleranceMode) {
        ...
        var draggableLeft, draggableTop, x1 = (draggable.positionAbs || draggable.position.absolute).left, x2 = x1 + draggable.helperProportions.width, y1 = (draggable.positionAbs || draggable.position.absolute).top, y2 = y1
                    ...
                    $.ui.mouse,
                    {
                        ...
                        _destroy : function() {
                            ...
                            var wrapper, _destroy = function(exp) {
                                $(exp).removeClass("ui-resizable ui-resizable-disabled ui-resizable-resizing").removeData("resizable").removeData(
                        ...
                        _respectSize : function(data) {
                            ...
                            var o = this._vBoundaries, a = this.axis, ismaxw = isNumber(data.width) && o.maxWidth && (o.maxWidth < data.width), ismaxh = isNumber(data.height)
                                    && o.maxHeight && (o.maxHeight < data.height), isminw = isNumber(data.width) && o.minWidth
                                    && (o.minWidth > data.width), isminh = isNumber(data.height) && o.minHeight && (o.minHeight > data.height), dw = this.originalPosition.left
                                    + this.originalSize.width, dh = this.position.top + this.size.height, cw = /sw|nw|w/.test(a), ch = /nw|ne|n/.test(a);
                            if (isminw) {
                        ...
                        _proportionallyResize : function() {
                            ...
                            for (i = 0; i < this._proportionallyResizeElements.length; i++) {
                                ...
                                if (!this.borderDif) {
                                    this.borderDif = [];
                                    borders = [ prel.css("borderTopWidth"), prel.css("borderRightWidth"), prel.css("borderBottomWidth"),
    ...
    $.ui.plugin.add("resizable", "animate", {
        ...
        stop : function(event) {
            var that = $(this).data("ui-resizable"), o = that.options, pr = that._proportionallyResizeElements, ista = pr.length
                    && (/textarea/i).test(pr[0].nodeName), soffseth = ista && $.ui.hasScroll(pr[0], "left") /*
                                                                                                             * TODO -
                                                                                                             * jump
                                                                                                             * height
                                                                                                             */? 0 : that.sizeDiff.height, soffsetw = ista ? 0 : that.sizeDiff.width, style = {
    ...
    $.ui.plugin.add("resizable", "alsoResize", {
        ...
        resize : function(event, ui) {
            ...
            _alsoResize = function(exp, c) {
                $(exp).each(
                        function() {
                            var el = $(this), start = $(this).data("ui-resizable-alsoresize"), style = {}, css = c && c.length ? c : el
            ...
            .widget(
                    ...
                    $.ui.mouse,
                    {
                        ...
                        _intersectsWithSides : function(item) {
                            ...
                            var isOverBottomHalf = isOverAxis(this.positionAbs.top + this.offset.click.top, item.top + (item.height / 2), item.height), isOverRightHalf = isOverAxis(
                                    this.positionAbs.left + this.offset.click.left, item.left + (item.width / 2), item.width), verticalDirection = this
                                ...
                                o.placeholder = {
                                    element : function() {
                                        ...
                                        var nodeName = that.currentItem[0].nodeName.toLowerCase(), element = $("<" + nodeName + ">", that.document[0])
                                                .addClass(className || that.currentItem[0].className + " ui-sortable-placeholder").removeClass(
                                                        "ui-sortable-helper");
                        ...
                        _convertPositionTo : function(d, pos) {
                            ...
                            return {
                                top : (pos.top + // The absolute mouse position
                                this.offset.relative.top * mod + // Only for relative positioned
                    ...
                    "ui.accordion",
                    {
                        ...
                        _destroy : function() {
                            ...
                            this.headers
                                    ...
                                    .removeAttr("role").removeAttr("aria-selected").removeAttr("aria-controls").removeAttr("tabIndex").each(function() {
                        ...
                        _processPanels : function() {
                            ...
                            this.headers.next().addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom").filter(
                        ...
                        _refresh : function() {
                            ...
                            this.active = this._findActive(options.active).addClass("ui-accordion-header-active ui-state-active ui-corner-top")
            ...
            .widget(
                    "ui.button",
                    {
                        ...
                        _resetButton : function() {
                            ...
                            var buttonElement = this.buttonElement.removeClass(typeClasses), buttonText = $("<span></span>", this.document[0]).addClass(
                                    "ui-button-text").html(this.options.label).appendTo(buttonElement.empty()).text(), icons = this.options.icons, multipleIcons = icons.primary
    ...
    $.widget("ui.buttonset", {
        ...
        refresh : function() {
            ...
            this.buttons = this.element.find(this.options.items).filter(":ui-button").button("refresh").end().not(":ui-button").button().end().map(
                    function() {
                        return $(this).button("widget")[0];
                    }).removeClass("ui-corner-all ui-corner-left ui-corner-right").filter(":first").addClass(rtl ? "ui-corner-right" : "ui-corner-left")
                    .end().filter(":last").addClass(rtl ? "ui-corner-left" : "ui-corner-right").end().end();
        },
...
(function($, undefined) {
    ...
    /*
     * Date picker manager. Use the singleton instance of this class, $.datepicker, to interact with
     * the date picker. Settings for (groups of) date pickers are maintained in an instance object,
    ...
    function Datepicker() {
        ...
        this._disableClass = "ui-datepicker-disabled"; // The name of the disabled covering marker
        // class
        this._unselectableClass = "ui-datepicker-unselectable"; // The name of the unselectable cell
        // marker class
        this._currentClass = "ui-datepicker-current-day"; // The name of the current day marker
        // class
        this._dayOverClass = "ui-datepicker-days-cell-over"; // The name of the day hover marker
        // class
        ...
        this._defaults = { // Global defaults for all the date picker instances
            ...
            changeMonth : false, // True if month can be selected directly, false if only
            // prev/next
                    ...
                    Datepicker.prototype,
                    {
                        ...
                        _destroyDatepicker : function(target) {
                            ...
                            if (nodeName === "input") {
                                inst.append.remove();
                                inst.trigger.remove();
                                $target.removeClass(this.markerClassName).unbind("focus", this._showDatepicker).unbind("keydown", this._doKeyDown).unbind(
                        ...
                        _checkOffset : function(inst, offset, isFixed) {
                            var dpWidth = inst.dpDiv.outerWidth(), dpHeight = inst.dpDiv.outerHeight(), inputWidth = inst.input ? inst.input.outerWidth()
                        ...
                        parseDate : function(format, value, settings) {
                            ...
                            getNumber = function(match) {
                                var isDoubled = lookAhead(match), size = (match === "@" ? 14 : (match === "!" ? 20 : (match === "y" && isDoubled ? 4
                                        : (match === "o" ? 3 : 2)))), digits = new RegExp("^\\d{1," + size + "}"), num = value.substring(iValue).match(
                                        digits);
                                if (!num) {
                        ...
                        _generateHTML : function(inst) {
                            ...
                            if (maxDate) {
                                maxDraw = this._daylightSavingAdjust(new Date(maxDate.getFullYear(), maxDate.getMonth() - (numMonths[0] * numMonths[1])
                                        + 1, maxDate.getDate()));
                            ...
                            for (row = 0; row < numMonths[0]; row++) {
                                ...
                                for (col = 0; col < numMonths[1]; col++) {
                                    ...
                                    for (dow = 0; dow < 7; dow++) { // days of the week
                                        day = (dow + firstDay) % 7;
                                        thead += "<th" + ((dow + firstDay + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + ">" + "<span title='"
                                    ...
                                    for (dRow = 0; dRow < numRows; dRow++) { // create date
                                        // picker rows
                                        calender += "<tr>";
                                        tbody = (!showWeek ? "" : "<td class='ui-datepicker-week-col'>" + this._get(inst, "calculateWeek")(printDate)
                                                + "</td>");
                        ...
                        _adjustInstDate : function(inst, offset, period) {
                            var year = inst.drawYear + (period === "Y" ? offset : 0), month = inst.drawMonth + (period === "M" ? offset : 0), day = Math
                                    ...
                                    + (period === "D" ? offset : 0), date = this._restrictMinMax(inst, this._daylightSavingAdjust(new Date(year, month,
                                    day)));
    ...
    /*
     * Bind hover events for datepicker elements. Done via delegate so the binding only occurs once
     * in the lifetime of the parent div. Global instActive, set by _updateDatepicker allows the
    ...
    /*
     * Invoke the datepicker functionality. @param options string - a command, optionally followed
     * by additional parameters or Object - settings for attaching new datepicker functionality
    ...
    $.widget("ui.menu", {
        ...
        _destroy : function() {
            ...
            this.element.removeAttr("aria-activedescendant").find(".ui-menu").addBack().removeClass(
                    ...
                    "aria-labelledby").removeAttr("aria-expanded").removeAttr("aria-hidden").removeAttr("aria-disabled").removeUniqueId().show();

            // Destroy menu items
            this.element.find(".ui-menu-item").removeClass("ui-menu-item").removeAttr("role").removeAttr("aria-disabled").children("a").removeUniqueId()
                    .removeClass("ui-corner-all ui-state-hover").removeAttr("tabIndex").removeAttr("role").removeAttr("aria-haspopup").children().each(
                            function() {
                                var elem = $(this);
        ...
        refresh : function() {
            ...
            submenus.filter(":not(.ui-menu)").addClass("ui-menu ui-widget ui-widget-content ui-corner-all").hide().attr({
                ...
                "aria-expanded" : "false"
                    ...
                    function() {
                        var menu = $(this), item = menu.prev("a"), submenuCarat = $("<span>").addClass("ui-menu-icon ui-icon " + icon).data(
            ...
            menus.children(":not(.ui-menu-item):has(a)").addClass("ui-menu-item").attr("role", "presentation").children("a").uniqueId().addClass(
                    "ui-corner-all").attr({
                tabIndex : -1,
                role : this._itemRole()
            });
        ...
        _close : function(startMenu) {
            ...
            startMenu.find(".ui-menu").hide().attr("aria-hidden", "true").attr("aria-expanded", "false").end().find("a.ui-state-active").removeClass(
                    "ui-state-active");
        },
...
(function($) {
    ...
    $.widget("ui.spinner", {
        ...
        _destroy : function() {
            this.element.removeClass("ui-spinner-input").prop("disabled", false).removeAttr("autocomplete").removeAttr("role").removeAttr("aria-valuemin")
                    .removeAttr("aria-valuemax").removeAttr("aria-valuenow");
            ...
            .widget(
                    "ui.tabs",
                    {
                        ...
                        _create : function() {
                            ...
                            this.element.addClass("ui-tabs  ui-corner-all").toggleClass("ui-tabs-collapsible", options.collapsible)
                        ...
                        _processTabs : function() {
                            ...
                            this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-tab-header")
                                    .attr("role", "tablist");
                                        ...
                                        if ($.data(this, "ui-tabs-destroy")) {
                                            ...
                                            $(this).removeClass(
                                                    "ui-state-default ui-state-active ui-state-disabled "
                                                            + "ui-corner-top ui-corner-bottom ui-widget-content ui-tabs-active ui-tabs-panel").removeAttr(
                                                    "tabIndex").removeAttr("aria-live").removeAttr("aria-busy").removeAttr("aria-selected").removeAttr(
                                        ...
                                        each(spaces, function(spaceName, space) {
                                            ...
                                            each(space.props, function(key, prop) {
                                                ...
                                                if (!inst[cache] && space.to) {
                                                    ...
                                                    // if the value was null, we don't need to copy
                                                    // it
                                                    // if the key was alpha, we don't need to copy
                                                    // it either
                                                ...
                                                // this is the only case where we allow nulls for
                                                // ALL properties.
    ...
    (function() {
        ...
        $.effects.animateClass = function(value, duration, easing, callback) {
            ...
            return this.queue(function() {
                var animated = $(this), baseClass = animated.attr("class") || "", applyClassChange, allAnimations = o.children ? animated.find("*")
                        .addBack() : animated;
    ...
    (function() {
        ...
        $.extend($.effects, {
            ...
            createWrapper : function(element) {
                ...
                wrapper = element.parent(); // Hotfix for jQuery 1.4 since some change in wrap()
                // seems to actually lose the reference to the wrapped
                // element
...
(function($, undefined) {
    ...
    $.effects.effect.blind = function(o, done) {
        // Create element
        var el = $(this), props = [ "position", "top", "bottom", "left", "right", "height", "width" ], mode = $.effects.setMode(el, o.mode || "hide"), direction = o.direction
...
(function($, undefined) {
    ...
    $.effects.effect.clip = function(o, done) {
        // Create element
        var el = $(this), props = [ "position", "top", "bottom", "left", "right", "height", "width" ], mode = $.effects.setMode(el, o.mode || "hide"), show = mode === "show", direction = o.direction
                || "vertical", vert = direction === "vertical", size = vert ? "height" : "width", position = vert ? "top" : "left", animation = {}, wrapper, animate, distance;
...
(function($, undefined) {
    ...
    $.effects.effect.drop = function(o, done) {
        ...
        var el = $(this), props = [ "position", "top", "bottom", "left", "right", "opacity", "height", "width" ], mode = $.effects.setMode(el, o.mode
                || "hide"), show = mode === "show", direction = o.direction || "left", ref = (direction === "up" || direction === "down") ? "top" : "left", motion = (direction === "up" || direction === "left") ? "pos"
                : "neg", animation = {
            opacity : show ? 1 : 0
        }, distance;
...
(function($, undefined) {
    ...
    $.effects.effect.fold = function(o, done) {
        ...
        // Create element
        var el = $(this), props = [ "position", "top", "bottom", "left", "right", "height", "width" ], mode = $.effects.setMode(el, o.mode || "hide"), show = mode === "show", hide = mode === "hide", size = o.size || 15, percent = /([0-9]+)%/
                .exec(size), horizFirst = !!o.horizFirst, widthFirst = show !== horizFirst, ref = widthFirst ? [ "width", "height" ]
...
(function($, undefined) {
    ...
    $.effects.effect.shake = function(o, done) {
        ...
        var el = $(this), props = [ "position", "top", "bottom", "left", "right", "height", "width" ], mode = $.effects.setMode(el, o.mode || "effect"), direction = o.direction
                || "left", distance = o.distance || 20, times = o.times || 3, anims = times * 2 + 1, speed = Math.round(o.duration / anims), ref = (direction === "up" || direction === "down") ? "top"
...
(function($, undefined) {
    ...
    $.effects.effect.slide = function(o, done) {
        ...
        // Create element
        var el = $(this), props = [ "position", "top", "bottom", "left", "right", "width", "height" ], mode = $.effects.setMode(el, o.mode || "show"), show = mode === "show", direction = o.direction
                || "left", ref = (direction === "up" || direction === "down") ? "top" : "left", positiveMotion = (direction === "up" || direction === "left"), distance, animation = {};
...
(function($, undefined) {
    ...
    $.effects.effect.transfer = function(o, done) {
        var elem = $(this), target = $(o.to), targetFixed = target.css("position") === "fixed", body = $("body"), fixTop = targetFixed ? body.scrollTop()
