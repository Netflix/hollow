...
public class RightsDeployablePackagesDelegateLookupImpl extends HollowObjectAbstractDelegate implements RightsDeployablePackagesDelegate {

    private final RightsDeployablePackagesTypeAPI typeAPI;

    public RightsDeployablePackagesDelegateLookupImpl(RightsDeployablePackagesTypeAPI typeAPI) {
