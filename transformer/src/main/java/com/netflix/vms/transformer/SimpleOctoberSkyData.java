...
public class SimpleOctoberSkyData implements OctoberSkyData {
	...
	private SimpleOctoberSkyData() {
		String countryCodes = "AA AD AE AF AG AI AL AM AO AQ AR AS AT AU AW AX AZ BA BB BD BE BF BG BH BI BJ BL "
		...
		this.countrySet = Collections.unmodifiableSet(
				new HashSet<String>(Arrays.asList(countryCodes.split(" ")))
		);
	}
