...
public class RolloutPhaseTrailerDelegateCachedImpl extends HollowObjectAbstractDelegate implements HollowCachedDelegate, RolloutPhaseTrailerDelegate {

    private final Long sequenceNumber;
    private final Long trailerMovieId;
    private final int supplementalInfoOrdinal;
   private RolloutPhaseTrailerTypeAPI typeAPI;

    public RolloutPhaseTrailerDelegateCachedImpl(RolloutPhaseTrailerTypeAPI typeAPI, int ordinal) {
    ...
    public void updateTypeAPI(HollowTypeAPI typeAPI) {
        this.typeAPI = (RolloutPhaseTrailerTypeAPI) typeAPI;
    }
