...
public class RolloutPhaseCharacterHollow extends HollowObject {

    public RolloutPhaseCharacterHollow(RolloutPhaseCharacterDelegate delegate, int ordinal) {
    ...
    public RolloutPhaseCharacterTypeAPI typeApi() {
        return delegate().getTypeAPI();
    }

    protected RolloutPhaseCharacterDelegate delegate() {
        return (RolloutPhaseCharacterDelegate)delegate;
    }
